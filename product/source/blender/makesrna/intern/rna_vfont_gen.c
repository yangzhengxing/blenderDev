...
void VectorFont_unpack(struct VFont *_self, ReportList *reports, int method)
{
	rna_VectorFont_unpack(_self, reports, method);
}
...
void rna_VectorFont_unpack(struct VFont *_self, ReportList *reports, int method);
...
StringPropertyRNA rna_VectorFont_filepath = {
	...
	rna_VectorFont_reload_update, 274399232, rna_VectorFont_filepath_editable, NULL,
	0, -1, NULL},
...
static EnumPropertyItem rna_VectorFont_unpack_method_items[5] = {
...
FunctionRNA rna_VectorFont_unpack_func = {
	...
	"unpack", 16, "Unpack the font to the samples filename",
...
StructRNA RNA_VectorFont = {
	...
	"VectorFont", NULL, NULL, 7, "Vector Font",
