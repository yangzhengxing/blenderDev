...
int OperatorOptions_is_grab_cursor_get(PointerRNA *ptr)
{
	wmOperator *data = (wmOperator *)(ptr->data);
	return (((data->flag) & 2) != 0);
}

int OperatorOptions_is_invoke_get(PointerRNA *ptr)
{
	wmOperator *data = (wmOperator *)(ptr->data);
	return (((data->flag) & 1) != 0);
}

int OperatorOptions_use_cursor_region_get(PointerRNA *ptr)
{
	wmOperator *data = (wmOperator *)(ptr->data);
	return (((data->flag) & 4) != 0);
}

void OperatorOptions_use_cursor_region_set(PointerRNA *ptr, int value)
{
	wmOperator *data = (wmOperator *)(ptr->data);
...
int Stereo3dDisplay_use_interlace_swap_get(PointerRNA *ptr)
{
	Stereo3dFormat *data = (Stereo3dFormat *)(ptr->data);
	return (((data->flag) & 1) != 0);
}

void Stereo3dDisplay_use_interlace_swap_set(PointerRNA *ptr, int value)
{
	Stereo3dFormat *data = (Stereo3dFormat *)(ptr->data);
...
int Stereo3dDisplay_use_sidebyside_crosseyed_get(PointerRNA *ptr)
{
	Stereo3dFormat *data = (Stereo3dFormat *)(ptr->data);
	return (((data->flag) & 2) != 0);
}

void Stereo3dDisplay_use_sidebyside_crosseyed_set(PointerRNA *ptr, int value)
{
	Stereo3dFormat *data = (Stereo3dFormat *)(ptr->data);
...
EnumPropertyRNA rna_Operator_bl_options = {
	{(PropertyRNA *)&rna_Operator_macros, (PropertyRNA *)&rna_Operator_bl_description,
...
BoolPropertyRNA rna_OperatorOptions_is_grab_cursor = {
	...
	-1, "is_grab_cursor", 2, "Grab Cursor",
...
BoolPropertyRNA rna_OperatorOptions_is_invoke = {
	{(PropertyRNA *)&rna_OperatorOptions_use_cursor_region, (PropertyRNA *)&rna_OperatorOptions_is_grab_cursor,
	-1, "is_invoke", 2, "Invoke",
...
BoolPropertyRNA rna_OperatorOptions_use_cursor_region = {
	{NULL, (PropertyRNA *)&rna_OperatorOptions_is_invoke,
	-1, "use_cursor_region", 3, "Focus Region",
...
StructRNA RNA_OperatorOptions = {
	...
	"OperatorOptions", NULL, NULL, 4, "Operator Options",
	"Runtime options",
	"*", 17,
...
static EnumPropertyItem rna_Event_type_items[199] = {
	{0, "NONE", 0, "", ""},
...
PointerPropertyRNA rna_Window_stereo_3d_display = {
	...
	-1, "stereo_3d_display", 8650752, "Stereo 3D Display",
...
static EnumPropertyItem rna_Stereo3dDisplay_display_mode_items[6] = {
...
static EnumPropertyItem rna_Stereo3dDisplay_anaglyph_type_items[4] = {
...
EnumPropertyRNA rna_Stereo3dDisplay_anaglyph_type = {
	...
	-1, "anaglyph_type", 3, "Anaglyph Type",
	"",
	0, "*",
	PROP_ENUM, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
static EnumPropertyItem rna_Stereo3dDisplay_interlace_type_items[4] = {
...
EnumPropertyRNA rna_Stereo3dDisplay_interlace_type = {
	...
	-1, "interlace_type", 3, "Interlace Type",
	"",
	0, "*",
	PROP_ENUM, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
BoolPropertyRNA rna_Stereo3dDisplay_use_interlace_swap = {
	...
	-1, "use_interlace_swap", 3, "Swap Left/Right",
...
BoolPropertyRNA rna_Stereo3dDisplay_use_sidebyside_crosseyed = {
	...
	-1, "use_sidebyside_crosseyed", 3, "Cross-Eyed",
...
StructRNA RNA_Stereo3dDisplay = {
	...
	"Stereo3dDisplay", NULL, NULL, 0, "Stereo 3D Display",
	"Settings for stereo 3D display",
	"*", 17,
...
static EnumPropertyItem rna_WindowManager_pupmenu_begin__internal_icon_items[551] = {
	{0, "NONE", 0, "NONE", ""},
...
EnumPropertyRNA rna_WindowManager_pupmenu_begin__internal_icon = {
	...
	NULL, 0, NULL, NULL,
	0, -1, NULL},
	NULL, NULL, NULL, NULL, NULL, NULL, rna_WindowManager_pupmenu_begin__internal_icon_items, 550, 0
};
...
static EnumPropertyItem rna_WindowManager_piemenu_begin__internal_icon_items[551] = {
	{0, "NONE", 0, "NONE", ""},
	{1, "QUESTION", 0, "QUESTION", ""},
	{2, "ERROR", 0, "ERROR", ""},
	{3, "CANCEL", 0, "CANCEL", ""},
...
EnumPropertyRNA rna_WindowManager_piemenu_begin__internal_icon = {
	...
	NULL, 0, NULL, NULL,
	0, -1, NULL},
	NULL, NULL, NULL, NULL, NULL, NULL, rna_WindowManager_piemenu_begin__internal_icon_items, 550, 0
};
...
static EnumPropertyItem rna_KeyMapItems_new_type_items[199] = {
	{0, "NONE", 0, "", ""},
	{1, "LEFTMOUSE", 0, "Left Mouse", "LMB"},
	{2, "MIDDLEMOUSE", 0, "Middle Mouse", "MMB"},
	{3, "RIGHTMOUSE", 0, "Right Mouse", "RMB"},
...
static EnumPropertyItem rna_KeyMapItems_new_key_modifier_items[199] = {
	{0, "NONE", 0, "", ""},
	{1, "LEFTMOUSE", 0, "Left Mouse", "LMB"},
	{2, "MIDDLEMOUSE", 0, "Middle Mouse", "MMB"},
	{3, "RIGHTMOUSE", 0, "Right Mouse", "RMB"},
...
static EnumPropertyItem rna_KeyMapItems_new_modal_type_items[199] = {
	{0, "NONE", 0, "", ""},
	{1, "LEFTMOUSE", 0, "Left Mouse", "LMB"},
	{2, "MIDDLEMOUSE", 0, "Middle Mouse", "MMB"},
	{3, "RIGHTMOUSE", 0, "Right Mouse", "RMB"},
...
static EnumPropertyItem rna_KeyMapItems_new_modal_key_modifier_items[199] = {
	{0, "NONE", 0, "", ""},
	{1, "LEFTMOUSE", 0, "Left Mouse", "LMB"},
	{2, "MIDDLEMOUSE", 0, "Middle Mouse", "MMB"},
	{3, "RIGHTMOUSE", 0, "Right Mouse", "RMB"},
...
static EnumPropertyItem rna_KeyMapItem_type_items[199] = {
	{0, "NONE", 0, "", ""},
	{1, "LEFTMOUSE", 0, "Left Mouse", "LMB"},
	{2, "MIDDLEMOUSE", 0, "Middle Mouse", "MMB"},
	{3, "RIGHTMOUSE", 0, "Right Mouse", "RMB"},
...
static EnumPropertyItem rna_KeyMapItem_key_modifier_items[199] = {
	{0, "NONE", 0, "", ""},
	{1, "LEFTMOUSE", 0, "Left Mouse", "LMB"},
	{2, "MIDDLEMOUSE", 0, "Middle Mouse", "MMB"},
	{3, "RIGHTMOUSE", 0, "Right Mouse", "RMB"},
