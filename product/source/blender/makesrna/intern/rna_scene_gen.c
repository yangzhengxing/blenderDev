...
PointerPropertyRNA rna_Scene_depsgraph;
...
extern FunctionRNA rna_Scene_collada_export_func;
extern StringPropertyRNA rna_Scene_collada_export_filepath;
extern BoolPropertyRNA rna_Scene_collada_export_apply_modifiers;
extern IntPropertyRNA rna_Scene_collada_export_export_mesh_type;
extern BoolPropertyRNA rna_Scene_collada_export_selected;
extern BoolPropertyRNA rna_Scene_collada_export_include_children;
extern BoolPropertyRNA rna_Scene_collada_export_include_armatures;
extern BoolPropertyRNA rna_Scene_collada_export_include_shapekeys;
extern BoolPropertyRNA rna_Scene_collada_export_deform_bones_only;
extern BoolPropertyRNA rna_Scene_collada_export_active_uv_only;
extern BoolPropertyRNA rna_Scene_collada_export_include_uv_textures;
extern BoolPropertyRNA rna_Scene_collada_export_include_material_textures;
extern BoolPropertyRNA rna_Scene_collada_export_use_texture_copies;
extern BoolPropertyRNA rna_Scene_collada_export_use_ngons;
extern BoolPropertyRNA rna_Scene_collada_export_use_object_instantiation;
extern BoolPropertyRNA rna_Scene_collada_export_sort_by_name;
extern BoolPropertyRNA rna_Scene_collada_export_open_sim;
extern IntPropertyRNA rna_Scene_collada_export_export_transformation_type;
...
BoolPropertyRNA rna_ToolSettings_use_gpencil_continuous_drawing;
BoolPropertyRNA rna_ToolSettings_use_gpencil_additive_drawing;
EnumPropertyRNA rna_ToolSettings_grease_pencil_source;
...
EnumPropertyRNA rna_ToolSettings_gpencil_stroke_placement_view2d;
EnumPropertyRNA rna_ToolSettings_gpencil_stroke_placement_sequencer_preview;
EnumPropertyRNA rna_ToolSettings_gpencil_stroke_placement_image_editor;
...
BoolPropertyRNA rna_SceneGameData_use_scene_hysteresis;
IntPropertyRNA rna_SceneGameData_scene_hysteresis_percentage;
...
BoolPropertyRNA rna_SceneRenderLayer_use_ao;
...
BoolPropertyRNA rna_GPUDOFSettings_use_high_quality;
BoolPropertyRNA rna_GPUDOFSettings_is_hq_supported;
...
PointerRNA Scene_depsgraph_get(PointerRNA *ptr)
{
	Scene *data = (Scene *)(ptr->data);
	return rna_pointer_inherit_refine(ptr, &RNA_Depsgraph, data->depsgraph);
}
...
int ToolSettings_use_proportional_action_get(PointerRNA *ptr)
{
	ToolSettings *data = (ToolSettings *)(ptr->data);
	return (int)(data->proportional_action);
}

void ToolSettings_use_proportional_action_set(PointerRNA *ptr, int value)
{
	ToolSettings *data = (ToolSettings *)(ptr->data);
	data->proportional_action = value;
}

int ToolSettings_use_proportional_fcurve_get(PointerRNA *ptr)
{
	ToolSettings *data = (ToolSettings *)(ptr->data);
	return (int)(data->proportional_fcurve);
}

void ToolSettings_use_proportional_fcurve_set(PointerRNA *ptr, int value)
{
	ToolSettings *data = (ToolSettings *)(ptr->data);
	data->proportional_fcurve = value;
}

int ToolSettings_lock_markers_get(PointerRNA *ptr)
{
	ToolSettings *data = (ToolSettings *)(ptr->data);
	return (int)(data->lock_markers);
}

void ToolSettings_lock_markers_set(PointerRNA *ptr, int value)
{
	ToolSettings *data = (ToolSettings *)(ptr->data);
...
int ToolSettings_use_snap_grid_absolute_get(PointerRNA *ptr)
{
	ToolSettings *data = (ToolSettings *)(ptr->data);
	return (((data->snap_flag) & 32) != 0);
}

void ToolSettings_use_snap_grid_absolute_set(PointerRNA *ptr, int value)
{
	ToolSettings *data = (ToolSettings *)(ptr->data);
...
int ToolSettings_use_gpencil_continuous_drawing_get(PointerRNA *ptr)
{
	ToolSettings *data = (ToolSettings *)(ptr->data);
	return (((data->gpencil_flags) & 1) != 0);
}

void ToolSettings_use_gpencil_continuous_drawing_set(PointerRNA *ptr, int value)
{
	ToolSettings *data = (ToolSettings *)(ptr->data);
...
int ToolSettings_use_gpencil_additive_drawing_get(PointerRNA *ptr)
{
	ToolSettings *data = (ToolSettings *)(ptr->data);
	return (((data->gpencil_flags) & 2) != 0);
}

void ToolSettings_use_gpencil_additive_drawing_set(PointerRNA *ptr, int value)
{
	ToolSettings *data = (ToolSettings *)(ptr->data);
...
int ToolSettings_grease_pencil_source_get(PointerRNA *ptr)
{
	ToolSettings *data = (ToolSettings *)(ptr->data);
	return ((data->gpencil_src) & 1);
}

void ToolSettings_grease_pencil_source_set(PointerRNA *ptr, int value)
{
	ToolSettings *data = (ToolSettings *)(ptr->data);
	data->gpencil_src &= ~1;
...
{
	ToolSettings *data = (ToolSettings *)(ptr->data);
	return ((data->gpencil_v3d_align) & 13);
}

void ToolSettings_gpencil_stroke_placement_view3d_set(PointerRNA *ptr, int value)
{
	ToolSettings *data = (ToolSettings *)(ptr->data);
	data->gpencil_v3d_align &= ~13;
	data->gpencil_v3d_align |= value;
}

int ToolSettings_use_gpencil_stroke_endpoints_get(PointerRNA *ptr)
{
	ToolSettings *data = (ToolSettings *)(ptr->data);
	return (((data->gpencil_v3d_align) & 16) != 0);
}

void ToolSettings_use_gpencil_stroke_endpoints_set(PointerRNA *ptr, int value)
{
	ToolSettings *data = (ToolSettings *)(ptr->data);
...
int ToolSettings_gpencil_stroke_placement_view2d_get(PointerRNA *ptr)
{
	ToolSettings *data = (ToolSettings *)(ptr->data);
	return ((data->gpencil_v2d_align) & 13);
}

void ToolSettings_gpencil_stroke_placement_view2d_set(PointerRNA *ptr, int value)
{
	ToolSettings *data = (ToolSettings *)(ptr->data);
	data->gpencil_v2d_align &= ~13;
	data->gpencil_v2d_align |= value;
}

int ToolSettings_gpencil_stroke_placement_sequencer_preview_get(PointerRNA *ptr)
{
	ToolSettings *data = (ToolSettings *)(ptr->data);
	return ((data->gpencil_seq_align) & 13);
}

void ToolSettings_gpencil_stroke_placement_sequencer_preview_set(PointerRNA *ptr, int value)
{
	ToolSettings *data = (ToolSettings *)(ptr->data);
	data->gpencil_seq_align &= ~13;
	data->gpencil_seq_align |= value;
}

int ToolSettings_gpencil_stroke_placement_image_editor_get(PointerRNA *ptr)
{
	ToolSettings *data = (ToolSettings *)(ptr->data);
	return ((data->gpencil_ima_align) & 13);
}

void ToolSettings_gpencil_stroke_placement_image_editor_set(PointerRNA *ptr, int value)
{
	ToolSettings *data = (ToolSettings *)(ptr->data);
	data->gpencil_ima_align &= ~13;
...
int Stereo3dFormat_use_interlace_swap_get(PointerRNA *ptr)
{
	Stereo3dFormat *data = (Stereo3dFormat *)(ptr->data);
	return (((data->flag) & 1) != 0);
}

void Stereo3dFormat_use_interlace_swap_set(PointerRNA *ptr, int value)
{
	Stereo3dFormat *data = (Stereo3dFormat *)(ptr->data);
	if (value) data->flag |= 1;
	else data->flag &= ~1;
...
int Stereo3dFormat_use_sidebyside_crosseyed_get(PointerRNA *ptr)
{
	Stereo3dFormat *data = (Stereo3dFormat *)(ptr->data);
	return (((data->flag) & 2) != 0);
}

void Stereo3dFormat_use_sidebyside_crosseyed_set(PointerRNA *ptr, int value)
{
	Stereo3dFormat *data = (Stereo3dFormat *)(ptr->data);
	if (value) data->flag |= 2;
	else data->flag &= ~2;
...
int Stereo3dFormat_use_squeezed_frame_get(PointerRNA *ptr)
{
	Stereo3dFormat *data = (Stereo3dFormat *)(ptr->data);
	return (((data->flag) & 4) != 0);
}

void Stereo3dFormat_use_squeezed_frame_set(PointerRNA *ptr, int value)
{
	Stereo3dFormat *data = (Stereo3dFormat *)(ptr->data);
	if (value) data->flag |= 4;
	else data->flag &= ~4;
...
int ImageFormatSettings_use_jpeg2k_ycc_get(PointerRNA *ptr)
{
	ImageFormatData *data = (ImageFormatData *)(ptr->data);
	return (((data->jp2_flag) & 1) != 0);
}

void ImageFormatSettings_use_jpeg2k_ycc_set(PointerRNA *ptr, int value)
{
	ImageFormatData *data = (ImageFormatData *)(ptr->data);
...
int ImageFormatSettings_use_jpeg2k_cinema_preset_get(PointerRNA *ptr)
{
	ImageFormatData *data = (ImageFormatData *)(ptr->data);
	return (((data->jp2_flag) & 2) != 0);
}

void ImageFormatSettings_use_jpeg2k_cinema_preset_set(PointerRNA *ptr, int value)
{
	ImageFormatData *data = (ImageFormatData *)(ptr->data);
...
int ImageFormatSettings_use_jpeg2k_cinema_48_get(PointerRNA *ptr)
{
	ImageFormatData *data = (ImageFormatData *)(ptr->data);
	return (((data->jp2_flag) & 4) != 0);
}

void ImageFormatSettings_use_jpeg2k_cinema_48_set(PointerRNA *ptr, int value)
{
	ImageFormatData *data = (ImageFormatData *)(ptr->data);
...
{
	GameData *data = (GameData *)(ptr->data);
	data->maxlogicstep = CLAMPIS(value, 1, 10000);
}
...
{
	GameData *data = (GameData *)(ptr->data);
	data->maxphystep = CLAMPIS(value, 1, 10000);
}
...
int SceneGameData_use_scene_hysteresis_get(PointerRNA *ptr)
{
	GameData *data = (GameData *)(ptr->data);
	return (((data->lodflag) & 1) != 0);
}

void SceneGameData_use_scene_hysteresis_set(PointerRNA *ptr, int value)
{
	GameData *data = (GameData *)(ptr->data);
	if (value) data->lodflag |= 1;
	else data->lodflag &= ~1;
}

int SceneGameData_scene_hysteresis_percentage_get(PointerRNA *ptr)
{
	GameData *data = (GameData *)(ptr->data);
	return (int)(data->scehysteresis);
}

void SceneGameData_scene_hysteresis_percentage_set(PointerRNA *ptr, int value)
{
	GameData *data = (GameData *)(ptr->data);
	data->scehysteresis = CLAMPIS(value, 0, 100);
}
...
{
	FFMpegCodecData *data = (FFMpegCodecData *)(ptr->data);
	data->gop_size = CLAMPIS(value, 0, 100);
}
...
int FFmpegSettings_use_autosplit_get(PointerRNA *ptr)
{
	FFMpegCodecData *data = (FFMpegCodecData *)(ptr->data);
	return (((data->flags) & 2) != 0);
}

void FFmpegSettings_use_autosplit_set(PointerRNA *ptr, int value)
{
	FFMpegCodecData *data = (FFMpegCodecData *)(ptr->data);
...
int FFmpegSettings_use_lossless_output_get(PointerRNA *ptr)
{
	FFMpegCodecData *data = (FFMpegCodecData *)(ptr->data);
	return (((data->flags) & 4) != 0);
}

void FFmpegSettings_use_lossless_output_set(PointerRNA *ptr, int value)
{
...
int RenderSettings_use_stamp_strip_meta_get(PointerRNA *ptr)
{
	RenderData *data = (RenderData *)(ptr->data);
	return (((data->stamp) & 4096) != 0);
}

void RenderSettings_use_stamp_strip_meta_set(PointerRNA *ptr, int value)
{
	RenderData *data = (RenderData *)(ptr->data);
...
int RenderSettings_use_multiview_get(PointerRNA *ptr)
{
	RenderData *data = (RenderData *)(ptr->data);
	return (((data->scemode) & 2097152) != 0);
}

void RenderSettings_use_multiview_set(PointerRNA *ptr, int value)
{
	RenderData *data = (RenderData *)(ptr->data);
...
int BakeSettings_use_pass_ambient_occlusion_get(PointerRNA *ptr)
{
	BakeData *data = (BakeData *)(ptr->data);
	return (((data->pass_filter) & 1) != 0);
}

void BakeSettings_use_pass_ambient_occlusion_set(PointerRNA *ptr, int value)
{
	BakeData *data = (BakeData *)(ptr->data);
...
int BakeSettings_use_pass_emit_get(PointerRNA *ptr)
{
	BakeData *data = (BakeData *)(ptr->data);
	return (((data->pass_filter) & 2) != 0);
}

void BakeSettings_use_pass_emit_set(PointerRNA *ptr, int value)
{
	BakeData *data = (BakeData *)(ptr->data);
...
int BakeSettings_use_pass_direct_get(PointerRNA *ptr)
{
	BakeData *data = (BakeData *)(ptr->data);
	return (((data->pass_filter) & 64) != 0);
}

void BakeSettings_use_pass_direct_set(PointerRNA *ptr, int value)
{
	BakeData *data = (BakeData *)(ptr->data);
...
int BakeSettings_use_pass_indirect_get(PointerRNA *ptr)
{
	BakeData *data = (BakeData *)(ptr->data);
	return (((data->pass_filter) & 128) != 0);
}

void BakeSettings_use_pass_indirect_set(PointerRNA *ptr, int value)
{
	BakeData *data = (BakeData *)(ptr->data);
...
int BakeSettings_use_pass_color_get(PointerRNA *ptr)
{
	BakeData *data = (BakeData *)(ptr->data);
	return (((data->pass_filter) & 256) != 0);
}

void BakeSettings_use_pass_color_set(PointerRNA *ptr, int value)
{
	BakeData *data = (BakeData *)(ptr->data);
...
int BakeSettings_use_pass_diffuse_get(PointerRNA *ptr)
{
	BakeData *data = (BakeData *)(ptr->data);
	return (((data->pass_filter) & 4) != 0);
}

void BakeSettings_use_pass_diffuse_set(PointerRNA *ptr, int value)
{
	BakeData *data = (BakeData *)(ptr->data);
...
int BakeSettings_use_pass_glossy_get(PointerRNA *ptr)
{
	BakeData *data = (BakeData *)(ptr->data);
	return (((data->pass_filter) & 8) != 0);
}

void BakeSettings_use_pass_glossy_set(PointerRNA *ptr, int value)
{
	BakeData *data = (BakeData *)(ptr->data);
...
int BakeSettings_use_pass_transmission_get(PointerRNA *ptr)
{
	BakeData *data = (BakeData *)(ptr->data);
	return (((data->pass_filter) & 16) != 0);
}

void BakeSettings_use_pass_transmission_set(PointerRNA *ptr, int value)
{
	BakeData *data = (BakeData *)(ptr->data);
...
int BakeSettings_use_pass_subsurface_get(PointerRNA *ptr)
{
	BakeData *data = (BakeData *)(ptr->data);
	return (((data->pass_filter) & 32) != 0);
}

void BakeSettings_use_pass_subsurface_set(PointerRNA *ptr, int value)
{
	BakeData *data = (BakeData *)(ptr->data);
...
void SceneRenderLayer_layers_zmask_set(PointerRNA *ptr, const int values[20])
{
	...
	for (i = 0; i < 20; i++) {
		if (values[i]) data->lay_zmask |= (1u << i);
...
void SceneRenderLayer_layers_exclude_set(PointerRNA *ptr, const int values[20])
{
	...
	for (i = 0; i < 20; i++) {
		if (values[i]) data->lay_exclude |= (1u << i);
...
int SceneRenderLayer_use_ao_get(PointerRNA *ptr)
{
	SceneRenderLayer *data = (SceneRenderLayer *)(ptr->data);
	return (((data->layflag) & 128) != 0);
}

void SceneRenderLayer_use_ao_set(PointerRNA *ptr, int value)
{
	SceneRenderLayer *data = (SceneRenderLayer *)(ptr->data);
...
int GPUDOFSettings_use_high_quality_get(PointerRNA *ptr)
{
	GPUDOFSettings *data = (GPUDOFSettings *)(ptr->data);
	return (((data->high_quality) & 1) != 0);
}

void GPUDOFSettings_use_high_quality_set(PointerRNA *ptr, int value)
{
	GPUDOFSettings *data = (GPUDOFSettings *)(ptr->data);
	if (value) data->high_quality |= 1;
	else data->high_quality &= ~1;
}

int GPUDOFSettings_is_hq_supported_get(PointerRNA *ptr)
{
	return rna_gpu_is_hq_supported_get(ptr);
}
...
int GPUFXSettings_use_dof_get(PointerRNA *ptr)
{
	GPUFXSettings *data = (GPUFXSettings *)(ptr->data);
	return (((data->fx_flag) & 1) != 0);
}

void GPUFXSettings_use_dof_set(PointerRNA *ptr, int value)
{
	GPUFXSettings *data = (GPUFXSettings *)(ptr->data);
...
int GPUFXSettings_use_ssao_get(PointerRNA *ptr)
{
	GPUFXSettings *data = (GPUFXSettings *)(ptr->data);
	return (((data->fx_flag) & 2) != 0);
}

void GPUFXSettings_use_ssao_set(PointerRNA *ptr, int value)
{
	GPUFXSettings *data = (GPUFXSettings *)(ptr->data);
...
int SceneRenderView_use_get(PointerRNA *ptr)
{
	SceneRenderView *data = (SceneRenderView *)(ptr->data);
	return !(((data->viewflag) & 1) != 0);
}

void SceneRenderView_use_set(PointerRNA *ptr, int value)
{
	SceneRenderView *data = (SceneRenderView *)(ptr->data);
...
void Scene_ray_cast(struct Scene *_self, float origin[3], float direction[3], float distance, int *result, float location[3], float normal[3], int *index, struct Object **object, float matrix[16])
{
	rna_Scene_ray_cast(_self, origin, direction, distance, result, location, normal, index, object, matrix);
}
...
void Scene_collada_export(struct Scene *_self, const char * filepath, int apply_modifiers, int export_mesh_type, int selected, int include_children, int include_armatures, int include_shapekeys, int deform_bones_only, int active_uv_only, int include_uv_textures, int include_material_textures, int use_texture_copies, int use_ngons, int use_object_instantiation, int sort_by_name, int open_sim, int export_transformation_type)
{
	rna_Scene_collada_export(_self, filepath, apply_modifiers, export_mesh_type, selected, include_children, include_armatures, include_shapekeys, deform_bones_only, active_uv_only, include_uv_textures, include_material_textures, use_texture_copies, use_ngons, use_object_instantiation, sort_by_name, open_sim, export_transformation_type);
}

void Scene_collada_export_call(bContext *C, ReportList *reports, PointerRNA *_ptr, ParameterList *_parms)
{
	struct Scene *_self;
	const char * filepath;
	int apply_modifiers;
	...
	_data += 4;
	export_mesh_type = *((int *)_data);
	_data += 4;
	selected = *((int *)_data);
	_data += 4;
	include_children = *((int *)_data);
	_data += 4;
	include_armatures = *((int *)_data);
	_data += 4;
	include_shapekeys = *((int *)_data);
	_data += 4;
	deform_bones_only = *((int *)_data);
	_data += 4;
	active_uv_only = *((int *)_data);
	_data += 4;
	include_uv_textures = *((int *)_data);
	_data += 4;
	include_material_textures = *((int *)_data);
	_data += 4;
	use_texture_copies = *((int *)_data);
	_data += 4;
	use_ngons = *((int *)_data);
	_data += 4;
	use_object_instantiation = *((int *)_data);
	_data += 4;
	sort_by_name = *((int *)_data);
	_data += 4;
	open_sim = *((int *)_data);
	_data += 4;
	export_transformation_type = *((int *)_data);
...
void rna_Scene_ray_cast(struct Scene *_self, float origin[3], float direction[3], float distance, int *result, float location[3], float normal[3], int *index, struct Object **object, float matrix[16]);
void rna_Scene_collada_export(struct Scene *_self, const char * filepath, int apply_modifiers, int export_mesh_type, int selected, int include_children, int include_armatures, int include_shapekeys, int deform_bones_only, int active_uv_only, int include_uv_textures, int include_material_textures, int use_texture_copies, int use_ngons, int use_object_instantiation, int sort_by_name, int open_sim, int export_transformation_type);
...
void RenderSettings_frame_path(struct RenderData *_self, int frame, int preview, const char * view, char * filepath)
{
	rna_SceneRender_get_frame_path(_self, frame, preview, view, filepath);
}
...
void rna_SceneRender_get_frame_path(struct RenderData *_self, int frame, int preview, const char * view, char * filepath);
...
PointerPropertyRNA rna_Scene_safe_areas = {
	...
	-1, "safe_areas", 8650752, "Safe Areas",
	"",
	0, "*",
	PROP_POINTER, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
CollectionPropertyRNA rna_Scene_timeline_markers = {
	{(PropertyRNA *)&rna_Scene_use_audio, (PropertyRNA *)&rna_Scene_safe_areas,
...
PointerPropertyRNA rna_Scene_sequencer_colorspace_settings = {
	{(PropertyRNA *)&rna_Scene_depsgraph, (PropertyRNA *)&rna_Scene_display_settings,
...
PointerPropertyRNA rna_Scene_depsgraph = {
	{NULL, (PropertyRNA *)&rna_Scene_sequencer_colorspace_settings,
	-1, "depsgraph", 8388608, "Dependency Graph",
	"Dependencies in the scene data",
	0, "*",
	PROP_POINTER, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
	0, -1, NULL},
	Scene_depsgraph_get, NULL, NULL, NULL,&RNA_Depsgraph
};
...
FloatPropertyRNA rna_Scene_ray_cast_origin = {
	{(PropertyRNA *)&rna_Scene_ray_cast_direction, NULL,
	-1, "origin", 7, "",
	"",
	0, "*",
...
FloatPropertyRNA rna_Scene_ray_cast_distance = {
	...
	NULL, 0, NULL, NULL,
	0, -1, NULL},
	NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0f, 170141173319264430000000000000000000000.0000000000f, 0.0f, 170141173319264430000000000000000000000.0000000000f, 1.0f, 3, 170141173319264430000000000000000000000.0000000000f, NULL
};
...
FunctionRNA rna_Scene_ray_cast_func = {
	{(FunctionRNA *)&rna_Scene_collada_export_func, (FunctionRNA *)&rna_Scene_uvedit_aspect_func,
	NULL,
	{(PropertyRNA *)&rna_Scene_ray_cast_origin, (PropertyRNA *)&rna_Scene_ray_cast_matrix}},
	"ray_cast", 0, "Cast a ray onto in object space",
	Scene_ray_cast_call,
	NULL
};

StringPropertyRNA rna_Scene_collada_export_filepath = {
	{(PropertyRNA *)&rna_Scene_collada_export_apply_modifiers, NULL,
	-1, "filepath", 262149, "File Path",
	"File path to write Collada file",
	0, "*",
...
BoolPropertyRNA rna_Scene_collada_export_apply_modifiers = {
	{(PropertyRNA *)&rna_Scene_collada_export_export_mesh_type, (PropertyRNA *)&rna_Scene_collada_export_filepath,
	-1, "apply_modifiers", 3, "Apply Modifiers",
	"Apply modifiers",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
IntPropertyRNA rna_Scene_collada_export_export_mesh_type = {
	{(PropertyRNA *)&rna_Scene_collada_export_selected, (PropertyRNA *)&rna_Scene_collada_export_apply_modifiers,
	-1, "export_mesh_type", 3, "Resolution",
...
BoolPropertyRNA rna_Scene_collada_export_selected = {
	{(PropertyRNA *)&rna_Scene_collada_export_include_children, (PropertyRNA *)&rna_Scene_collada_export_export_mesh_type,
	-1, "selected", 3, "Selection Only",
...
BoolPropertyRNA rna_Scene_collada_export_include_children = {
	{(PropertyRNA *)&rna_Scene_collada_export_include_armatures, (PropertyRNA *)&rna_Scene_collada_export_selected,
	-1, "include_children", 3, "Include Children",
...
BoolPropertyRNA rna_Scene_collada_export_include_armatures = {
	{(PropertyRNA *)&rna_Scene_collada_export_include_shapekeys, (PropertyRNA *)&rna_Scene_collada_export_include_children,
	-1, "include_armatures", 3, "Include Armatures",
...
BoolPropertyRNA rna_Scene_collada_export_include_shapekeys = {
	{(PropertyRNA *)&rna_Scene_collada_export_deform_bones_only, (PropertyRNA *)&rna_Scene_collada_export_include_armatures,
	-1, "include_shapekeys", 3, "Include Shape Keys",
...
BoolPropertyRNA rna_Scene_collada_export_deform_bones_only = {
	{(PropertyRNA *)&rna_Scene_collada_export_active_uv_only, (PropertyRNA *)&rna_Scene_collada_export_include_shapekeys,
	-1, "deform_bones_only", 3, "Deform Bones only",
...
BoolPropertyRNA rna_Scene_collada_export_active_uv_only = {
	{(PropertyRNA *)&rna_Scene_collada_export_include_uv_textures, (PropertyRNA *)&rna_Scene_collada_export_deform_bones_only,
	-1, "active_uv_only", 3, "Active UV Layer only",
	"Export only the active UV Layer",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
	0, -1, NULL},
...
BoolPropertyRNA rna_Scene_collada_export_include_uv_textures = {
	{(PropertyRNA *)&rna_Scene_collada_export_include_material_textures, (PropertyRNA *)&rna_Scene_collada_export_active_uv_only,
	-1, "include_uv_textures", 3, "Include UV Textures",
...
BoolPropertyRNA rna_Scene_collada_export_include_material_textures = {
	{(PropertyRNA *)&rna_Scene_collada_export_use_texture_copies, (PropertyRNA *)&rna_Scene_collada_export_include_uv_textures,
	-1, "include_material_textures", 3, "Include Material Textures",
...
BoolPropertyRNA rna_Scene_collada_export_use_texture_copies = {
	{(PropertyRNA *)&rna_Scene_collada_export_use_ngons, (PropertyRNA *)&rna_Scene_collada_export_include_material_textures,
	-1, "use_texture_copies", 3, "copy",
...
BoolPropertyRNA rna_Scene_collada_export_use_ngons = {
	{(PropertyRNA *)&rna_Scene_collada_export_use_object_instantiation, (PropertyRNA *)&rna_Scene_collada_export_use_texture_copies,
	-1, "use_ngons", 3, "Use NGons",
	"Keep NGons in Export",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
	0, -1, NULL},
...
BoolPropertyRNA rna_Scene_collada_export_use_object_instantiation = {
	{(PropertyRNA *)&rna_Scene_collada_export_sort_by_name, (PropertyRNA *)&rna_Scene_collada_export_use_ngons,
	-1, "use_object_instantiation", 3, "Use Object Instances",
...
BoolPropertyRNA rna_Scene_collada_export_sort_by_name = {
	{(PropertyRNA *)&rna_Scene_collada_export_open_sim, (PropertyRNA *)&rna_Scene_collada_export_use_object_instantiation,
	-1, "sort_by_name", 3, "Sort by Object name",
...
BoolPropertyRNA rna_Scene_collada_export_open_sim = {
	{(PropertyRNA *)&rna_Scene_collada_export_export_transformation_type, (PropertyRNA *)&rna_Scene_collada_export_sort_by_name,
	-1, "open_sim", 3, "Export for SL/OpenSim",
...
IntPropertyRNA rna_Scene_collada_export_export_transformation_type = {
	{NULL, (PropertyRNA *)&rna_Scene_collada_export_open_sim,
	-1, "export_transformation_type", 3, "Transformation",
...
FunctionRNA rna_Scene_collada_export_func = {
	{NULL, (FunctionRNA *)&rna_Scene_ray_cast_func,
	NULL,
	{(PropertyRNA *)&rna_Scene_collada_export_filepath, (PropertyRNA *)&rna_Scene_collada_export_export_transformation_type}},
	"collada_export", 0, "Export to collada file",
	Scene_collada_export_call,
	NULL
};
...
StructRNA RNA_Scene = {
	...
	NULL,
	{(PropertyRNA *)&rna_Scene_camera, (PropertyRNA *)&rna_Scene_depsgraph}},
	...
	NULL,
	rna_ID_idprops,
	{(FunctionRNA *)&rna_Scene_sequence_editor_create_func, (FunctionRNA *)&rna_Scene_collada_export_func}
};
...
BoolPropertyRNA rna_ToolSettings_use_proportional_action = {
	...
	-1, "use_proportional_action", 12289, "Proportional Editing Actions",
...
BoolPropertyRNA rna_ToolSettings_use_proportional_fcurve = {
	...
	-1, "use_proportional_fcurve", 12289, "Proportional Editing FCurves",
...
BoolPropertyRNA rna_ToolSettings_lock_markers = {
	...
	-1, "lock_markers", 8193, "Lock Markers",
...
static EnumPropertyItem rna_ToolSettings_proportional_edit_falloff_items[9] = {
...
BoolPropertyRNA rna_ToolSettings_use_snap_grid_absolute = {
	{(PropertyRNA *)&rna_ToolSettings_snap_element, (PropertyRNA *)&rna_ToolSettings_use_snap_align_rotation,
	-1, "use_snap_grid_absolute", 1, "Absolute Grid Snap",
...
static EnumPropertyItem rna_ToolSettings_snap_element_items[6] = {
	{0, "INCREMENT", 584, "Increment", "Snap to increments of grid"},
...
BoolPropertyRNA rna_ToolSettings_use_snap_self = {
	{(PropertyRNA *)&rna_ToolSettings_use_gpencil_continuous_drawing, (PropertyRNA *)&rna_ToolSettings_use_snap_project,
...
BoolPropertyRNA rna_ToolSettings_use_gpencil_continuous_drawing = {
	{(PropertyRNA *)&rna_ToolSettings_use_gpencil_additive_drawing, (PropertyRNA *)&rna_ToolSettings_use_snap_self,
	-1, "use_gpencil_continuous_drawing", 1, "Use Continuous Drawing",
	"Allow drawing multiple strokes at a time with Grease Pencil",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 68091904, NULL, NULL,
	0, -1, NULL},
	ToolSettings_use_gpencil_continuous_drawing_get, ToolSettings_use_gpencil_continuous_drawing_set, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL
};

BoolPropertyRNA rna_ToolSettings_use_gpencil_additive_drawing = {
	{(PropertyRNA *)&rna_ToolSettings_grease_pencil_source, (PropertyRNA *)&rna_ToolSettings_use_gpencil_continuous_drawing,
	-1, "use_gpencil_additive_drawing", 1, "Use Additive Drawing",
	"When creating new frames, the strokes from the previous/active frame are included as the basis for the new one",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 68091904, NULL, NULL,
	0, -1, NULL},
	ToolSettings_use_gpencil_additive_drawing_get, ToolSettings_use_gpencil_additive_drawing_set, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL
};

static EnumPropertyItem rna_ToolSettings_grease_pencil_source_items[3] = {
	{0, "SCENE", 0, "Scene", "Grease Pencil data attached to the current scene is used, unless the active object already has Grease Pencil data (i.e. for old files)"},
	{1, "OBJECT", 0, "Object", "Grease Pencil data-blocks attached to the active object are used (required when using pre 2.73 add-ons, e.g. BSurfaces)"},
	{0, NULL, 0, NULL, NULL}
};

EnumPropertyRNA rna_ToolSettings_grease_pencil_source = {
	{(PropertyRNA *)&rna_ToolSettings_gpencil_sculpt, (PropertyRNA *)&rna_ToolSettings_use_gpencil_additive_drawing,
	-1, "grease_pencil_source", 1, "Grease Pencil Source",
	"Datablock where active Grease Pencil data is found from",
	0, "*",
	PROP_ENUM, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 375062528, NULL, NULL,
	0, -1, NULL},
	ToolSettings_grease_pencil_source_get, ToolSettings_grease_pencil_source_set, NULL, NULL, NULL, NULL, rna_ToolSettings_grease_pencil_source_items, 2, 0
};

PointerPropertyRNA rna_ToolSettings_gpencil_sculpt = {
	{(PropertyRNA *)&rna_ToolSettings_gpencil_stroke_placement_view3d, (PropertyRNA *)&rna_ToolSettings_grease_pencil_source,
	-1, "gpencil_sculpt", 8388608, "Grease Pencil Sculpt",
	"",
	0, "*",
	PROP_POINTER, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
static EnumPropertyItem rna_ToolSettings_gpencil_stroke_placement_view3d_items[5] = {
	{1, "CURSOR", 0, "Cursor", "Draw stroke at the 3D cursor"},
	{0, "VIEW", 0, "View", "Stick stroke to the view "},
	{5, "SURFACE", 0, "Surface", "Stick stroke to surfaces"},
	{9, "STROKE", 0, "Stroke", "Stick stroke to other strokes"},
	{0, NULL, 0, NULL, NULL}
};

EnumPropertyRNA rna_ToolSettings_gpencil_stroke_placement_view3d = {
	{(PropertyRNA *)&rna_ToolSettings_use_gpencil_stroke_endpoints, (PropertyRNA *)&rna_ToolSettings_gpencil_sculpt,
	-1, "gpencil_stroke_placement_view3d", 1, "Stroke Placement (3D View)",
	"",
	0, "*",
	PROP_ENUM, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 375062528, NULL, NULL,
	0, -1, NULL},
	ToolSettings_gpencil_stroke_placement_view3d_get, ToolSettings_gpencil_stroke_placement_view3d_set, NULL, NULL, NULL, NULL, rna_ToolSettings_gpencil_stroke_placement_view3d_items, 4, 0
};

BoolPropertyRNA rna_ToolSettings_use_gpencil_stroke_endpoints = {
	{(PropertyRNA *)&rna_ToolSettings_gpencil_stroke_placement_view2d, (PropertyRNA *)&rna_ToolSettings_gpencil_stroke_placement_view3d,
	-1, "use_gpencil_stroke_endpoints", 1, "Only Endpoints",
...
static EnumPropertyItem rna_ToolSettings_gpencil_stroke_placement_view2d_items[5] = {
	{1, "CURSOR", 0, "Cursor", "Draw stroke at the 3D cursor"},
	{0, "VIEW", 0, "View", "Stick stroke to the view "},
	{5, "SURFACE", 0, "Surface", "Stick stroke to surfaces"},
	{9, "STROKE", 0, "Stroke", "Stick stroke to other strokes"},
...
EnumPropertyRNA rna_ToolSettings_gpencil_stroke_placement_view2d = {
	{(PropertyRNA *)&rna_ToolSettings_gpencil_stroke_placement_sequencer_preview, (PropertyRNA *)&rna_ToolSettings_use_gpencil_stroke_endpoints,
	-1, "gpencil_stroke_placement_view2d", 1, "Stroke Placement (2D View)",
	"",
	0, "*",
	PROP_ENUM, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 375062528, NULL, NULL,
	0, -1, NULL},
	ToolSettings_gpencil_stroke_placement_view2d_get, ToolSettings_gpencil_stroke_placement_view2d_set, NULL, NULL, NULL, NULL, rna_ToolSettings_gpencil_stroke_placement_view2d_items, 4, 0
};

static EnumPropertyItem rna_ToolSettings_gpencil_stroke_placement_sequencer_preview_items[5] = {
	{1, "CURSOR", 0, "Cursor", "Draw stroke at the 3D cursor"},
	{0, "VIEW", 0, "View", "Stick stroke to the view "},
	{5, "SURFACE", 0, "Surface", "Stick stroke to surfaces"},
	{9, "STROKE", 0, "Stroke", "Stick stroke to other strokes"},
...
EnumPropertyRNA rna_ToolSettings_gpencil_stroke_placement_sequencer_preview = {
	{(PropertyRNA *)&rna_ToolSettings_gpencil_stroke_placement_image_editor, (PropertyRNA *)&rna_ToolSettings_gpencil_stroke_placement_view2d,
	-1, "gpencil_stroke_placement_sequencer_preview", 1, "Stroke Placement (Sequencer Preview)",
	"",
	0, "*",
	PROP_ENUM, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 375062528, NULL, NULL,
	0, -1, NULL},
	ToolSettings_gpencil_stroke_placement_sequencer_preview_get, ToolSettings_gpencil_stroke_placement_sequencer_preview_set, NULL, NULL, NULL, NULL, rna_ToolSettings_gpencil_stroke_placement_sequencer_preview_items, 4, 0
};

static EnumPropertyItem rna_ToolSettings_gpencil_stroke_placement_image_editor_items[5] = {
	{1, "CURSOR", 0, "Cursor", "Draw stroke at the 3D cursor"},
	{0, "VIEW", 0, "View", "Stick stroke to the view "},
	{5, "SURFACE", 0, "Surface", "Stick stroke to surfaces"},
	{9, "STROKE", 0, "Stroke", "Stick stroke to other strokes"},
...
EnumPropertyRNA rna_ToolSettings_gpencil_stroke_placement_image_editor = {
	{(PropertyRNA *)&rna_ToolSettings_use_keyframe_insert_auto, (PropertyRNA *)&rna_ToolSettings_gpencil_stroke_placement_sequencer_preview,
	-1, "gpencil_stroke_placement_image_editor", 1, "Stroke Placement (Image Editor)",
	"",
	0, "*",
	PROP_ENUM, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 375062528, NULL, NULL,
	0, -1, NULL},
	ToolSettings_gpencil_stroke_placement_image_editor_get, ToolSettings_gpencil_stroke_placement_image_editor_set, NULL, NULL, NULL, NULL, rna_ToolSettings_gpencil_stroke_placement_image_editor_items, 4, 0
};

BoolPropertyRNA rna_ToolSettings_use_keyframe_insert_auto = {
	{(PropertyRNA *)&rna_ToolSettings_auto_keying_mode, (PropertyRNA *)&rna_ToolSettings_gpencil_stroke_placement_image_editor,
...
static EnumPropertyItem rna_Stereo3dFormat_display_mode_items[5] = {
...
EnumPropertyRNA rna_Stereo3dFormat_display_mode = {
	...
	-1, "display_mode", 1, "Stereo Mode",
	"",
	0, "*",
	PROP_ENUM, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Stereo3dFormat_update, 171114496, NULL, NULL,
	0, -1, NULL},
...
static EnumPropertyItem rna_Stereo3dFormat_anaglyph_type_items[4] = {
...
EnumPropertyRNA rna_Stereo3dFormat_anaglyph_type = {
	...
	-1, "anaglyph_type", 1, "Anaglyph Type",
	"",
	0, "*",
	PROP_ENUM, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Stereo3dFormat_update, 171114496, NULL, NULL,
...
static EnumPropertyItem rna_Stereo3dFormat_interlace_type_items[4] = {
...
EnumPropertyRNA rna_Stereo3dFormat_interlace_type = {
	...
	-1, "interlace_type", 1, "Interlace Type",
	"",
	0, "*",
	PROP_ENUM, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Stereo3dFormat_update, 171114496, NULL, NULL,
...
BoolPropertyRNA rna_Stereo3dFormat_use_interlace_swap = {
	...
	-1, "use_interlace_swap", 1, "Swap Left/Right",
...
BoolPropertyRNA rna_Stereo3dFormat_use_sidebyside_crosseyed = {
	...
	-1, "use_sidebyside_crosseyed", 1, "Cross-Eyed",
...
BoolPropertyRNA rna_Stereo3dFormat_use_squeezed_frame = {
	...
	-1, "use_squeezed_frame", 1, "Squeezed Frame",
...
StructRNA RNA_Stereo3dFormat = {
	...
	"Stereo3dFormat", NULL, NULL, 0, "Stereo Output",
...
static EnumPropertyItem rna_ImageFormatSettings_file_format_items[24] = {
	{0, "", 0, "Image", NULL},
...
EnumPropertyRNA rna_ImageFormatSettings_file_format = {
	...
	NULL, 67371008, NULL, NULL,
	0, -1, NULL},
	ImageFormatSettings_file_format_get, ImageFormatSettings_file_format_set, rna_ImageFormatSettings_file_format_itemf, NULL, NULL, NULL, rna_ImageFormatSettings_file_format_items, 23, 0
};
...
static EnumPropertyItem rna_ImageFormatSettings_exr_codec_items[11] = {
	{0, "NONE", 0, "None", ""},
...
EnumPropertyRNA rna_ImageFormatSettings_exr_codec = {
	...
	NULL, 67371008, NULL, NULL,
	0, -1, NULL},
	ImageFormatSettings_exr_codec_get, ImageFormatSettings_exr_codec_set, rna_ImageFormatSettings_exr_codec_itemf, NULL, NULL, NULL, rna_ImageFormatSettings_exr_codec_items, 10, 0
};

BoolPropertyRNA rna_ImageFormatSettings_use_jpeg2k_ycc = {
	{(PropertyRNA *)&rna_ImageFormatSettings_use_jpeg2k_cinema_preset, (PropertyRNA *)&rna_ImageFormatSettings_exr_codec,
	-1, "use_jpeg2k_ycc", 1, "YCC",
...
BoolPropertyRNA rna_ImageFormatSettings_use_jpeg2k_cinema_preset = {
	...
	-1, "use_jpeg2k_cinema_preset", 1, "Cinema",
...
BoolPropertyRNA rna_ImageFormatSettings_use_jpeg2k_cinema_48 = {
	...
	-1, "use_jpeg2k_cinema_48", 1, "Cinema (48)",
...
static EnumPropertyItem rna_ImageFormatSettings_jpeg2k_codec_items[3] = {
	{0, "JP2", 0, "JP2", ""},
	{1, "J2K", 0, "J2K", ""},
	{0, NULL, 0, NULL, NULL}
};
...
static EnumPropertyItem rna_ImageFormatSettings_tiff_codec_items[5] = {
	{3, "NONE", 0, "None", ""},
	{0, "DEFLATE", 0, "Deflate", ""},
	{1, "LZW", 0, "LZW", ""},
...
static EnumPropertyItem rna_ImageFormatSettings_views_format_items[3] = {
...
StructRNA RNA_ImageFormatSettings = {
	{(ContainerRNA *)&RNA_SceneGameData, (ContainerRNA *)&RNA_Stereo3dFormat,
	NULL,
...
static EnumPropertyItem rna_SceneGameData_exit_key_items[199] = {
	{0, "NONE", 0, "", ""},
...
EnumPropertyRNA rna_SceneGameData_exit_key = {
	...
	NULL, 67108864, NULL, NULL,
	0, -1, NULL},
	SceneGameData_exit_key_get, SceneGameData_exit_key_set, NULL, NULL, NULL, NULL, rna_SceneGameData_exit_key_items, 198, 218
};

static EnumPropertyItem rna_SceneGameData_raster_storage_items[4] = {
	{0, "AUTO", 0, "Auto Select", "Choose the best supported mode"},
	{2, "VERTEX_ARRAY", 0, "Vertex Arrays", "Usually the best choice (good performance with display lists)"},
	{3, "VERTEX_BUFFER_OBJECT", 0, "Vertex Buffer Objects", "Typically slower than vertex arrays with display lists, requires at least OpenGL 1.4"},
	{0, NULL, 0, NULL, NULL}
};
...
EnumPropertyRNA rna_SceneGameData_stereo_mode = {
	...
	NULL, 67108864, NULL, NULL,
	0, -1, NULL},
	SceneGameData_stereo_mode_get, SceneGameData_stereo_mode_set, NULL, NULL, NULL, NULL, rna_SceneGameData_stereo_mode_items, 7, 5
};
...
FloatPropertyRNA rna_SceneGameData_stereo_eye_separation = {
	...
	SceneGameData_stereo_eye_separation_get, SceneGameData_stereo_eye_separation_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0099999998f, 5.0f, 0.0099999998f, 5.0f, 10.0f, 3, 0.1000000015f, NULL
};
...
FloatPropertyRNA rna_SceneGameData_dome_buffer_resolution = {
	...
	SceneGameData_dome_buffer_resolution_get, SceneGameData_dome_buffer_resolution_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.1000000015f, 1.0f, -FLT_MAX, FLT_MAX, 0.1000000015f, 2, 1.0f, NULL
};
...
EnumPropertyRNA rna_SceneGameData_physics_engine = {
	...
	NULL, 67108864, NULL, NULL,
	0, -1, NULL},
	SceneGameData_physics_engine_get, SceneGameData_physics_engine_set, NULL, NULL, NULL, NULL, rna_SceneGameData_physics_engine_items, 2, 5
};
...
FloatPropertyRNA rna_SceneGameData_physics_gravity = {
	...
	SceneGameData_physics_gravity_get, SceneGameData_physics_gravity_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0f, 10000.0f, 0.0f, 10000.0f, 1.0f, 2, 9.8000001907f, NULL
};
...
FloatPropertyRNA rna_SceneGameData_deactivation_linear_threshold = {
	...
	SceneGameData_deactivation_linear_threshold_get, SceneGameData_deactivation_linear_threshold_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0010000000f, 10000.0f, 0.0010000000f, 10000.0f, 2.0f, 3, 0.8000000119f, NULL
};
...
FloatPropertyRNA rna_SceneGameData_deactivation_angular_threshold = {
	...
	SceneGameData_deactivation_angular_threshold_get, SceneGameData_deactivation_angular_threshold_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0010000000f, 10000.0f, 0.0010000000f, 10000.0f, 2.0f, 3, 1.0f, NULL
};
...
FloatPropertyRNA rna_SceneGameData_level_height = {
	...
	SceneGameData_level_height_get, SceneGameData_level_height_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0f, 200.0f, 0.0f, 200.0f, 10.0f, 3, 2.0f, NULL
};
...
PointerPropertyRNA rna_SceneGameData_recast_data = {
	{(PropertyRNA *)&rna_SceneGameData_use_scene_hysteresis, (PropertyRNA *)&rna_SceneGameData_show_obstacle_simulation,
...
BoolPropertyRNA rna_SceneGameData_use_scene_hysteresis = {
	{(PropertyRNA *)&rna_SceneGameData_scene_hysteresis_percentage, (PropertyRNA *)&rna_SceneGameData_recast_data,
	-1, "use_scene_hysteresis", 1, "Hysteresis",
	"Use LoD Hysteresis setting for the scene",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 67108864, NULL, NULL,
	0, -1, NULL},
	SceneGameData_use_scene_hysteresis_get, SceneGameData_use_scene_hysteresis_set, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL
};

IntPropertyRNA rna_SceneGameData_scene_hysteresis_percentage = {
	{NULL, (PropertyRNA *)&rna_SceneGameData_use_scene_hysteresis,
	-1, "scene_hysteresis_percentage", 8193, "Hysteresis %",
	"Minimum distance change required to transition to the previous level of detail",
	0, "*",
	PROP_INT, PROP_PERCENTAGE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 67108864, NULL, NULL,
	offsetof(GameData, scehysteresis), 0, NULL},
	SceneGameData_scene_hysteresis_percentage_get, SceneGameData_scene_hysteresis_percentage_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL,
	0, 100, 0, 100, 10, 10, NULL
};

StructRNA RNA_SceneGameData = {
	{(ContainerRNA *)&RNA_SceneGameRecastData, (ContainerRNA *)&RNA_ImageFormatSettings,
	NULL,
	{(PropertyRNA *)&rna_SceneGameData_rna_properties, (PropertyRNA *)&rna_SceneGameData_scene_hysteresis_percentage}},
...
FloatPropertyRNA rna_SceneGameRecastData_cell_size = {
	...
	SceneGameRecastData_cell_size_get, SceneGameRecastData_cell_size_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.1000000015f, 1.0f, -FLT_MAX, FLT_MAX, 1.0f, 2, 0.3000000119f, NULL
};
...
FloatPropertyRNA rna_SceneGameRecastData_cell_height = {
	...
	SceneGameRecastData_cell_height_get, SceneGameRecastData_cell_height_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.1000000015f, 1.0f, -FLT_MAX, FLT_MAX, 1.0f, 2, 0.2000000030f, NULL
};
...
FloatPropertyRNA rna_SceneGameRecastData_agent_height = {
	...
	SceneGameRecastData_agent_height_get, SceneGameRecastData_agent_height_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.1000000015f, 5.0f, -FLT_MAX, FLT_MAX, 1.0f, 2, 2.0f, NULL
};
...
FloatPropertyRNA rna_SceneGameRecastData_agent_radius = {
	...
	SceneGameRecastData_agent_radius_get, SceneGameRecastData_agent_radius_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.1000000015f, 5.0f, -FLT_MAX, FLT_MAX, 1.0f, 2, 0.6000000238f, NULL
};
...
FloatPropertyRNA rna_SceneGameRecastData_climb_max = {
	...
	SceneGameRecastData_climb_max_get, SceneGameRecastData_climb_max_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.1000000015f, 5.0f, -FLT_MAX, FLT_MAX, 1.0f, 2, 0.8999999762f, NULL
};
...
FloatPropertyRNA rna_SceneGameRecastData_slope_max = {
	...
	SceneGameRecastData_slope_max_get, SceneGameRecastData_slope_max_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0f, 1.5707963705f, 0.0f, 1.5707963705f, 10.0f, 3, 0.7853981853f, NULL
};
...
FloatPropertyRNA rna_SceneGameRecastData_region_min_size = {
	...
	SceneGameRecastData_region_min_size_get, SceneGameRecastData_region_min_size_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0f, 150.0f, -FLT_MAX, FLT_MAX, 1.0f, 2, 8.0f, NULL
};
...
FloatPropertyRNA rna_SceneGameRecastData_region_merge_size = {
	...
	SceneGameRecastData_region_merge_size_get, SceneGameRecastData_region_merge_size_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0f, 150.0f, -FLT_MAX, FLT_MAX, 1.0f, 2, 20.0f, NULL
};
...
FloatPropertyRNA rna_SceneGameRecastData_edge_max_len = {
	...
	SceneGameRecastData_edge_max_len_get, SceneGameRecastData_edge_max_len_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0f, 50.0f, -FLT_MAX, FLT_MAX, 1.0f, 2, 12.0f, NULL
};
...
FloatPropertyRNA rna_SceneGameRecastData_edge_max_error = {
	...
	SceneGameRecastData_edge_max_error_get, SceneGameRecastData_edge_max_error_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.1000000015f, 3.0f, -FLT_MAX, FLT_MAX, 1.0f, 2, 1.2999999523f, NULL
};
...
FloatPropertyRNA rna_SceneGameRecastData_sample_dist = {
	...
	SceneGameRecastData_sample_dist_get, SceneGameRecastData_sample_dist_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0f, 16.0f, -FLT_MAX, FLT_MAX, 1.0f, 2, 6.0f, NULL
};
...
FloatPropertyRNA rna_SceneGameRecastData_sample_max_error = {
	...
	SceneGameRecastData_sample_max_error_get, SceneGameRecastData_sample_max_error_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0f, 16.0f, -FLT_MAX, FLT_MAX, 1.0f, 2, 1.0f, NULL
};
...
StructRNA RNA_SelectedUvElement = {
	{(ContainerRNA *)&RNA_DisplaySafeAreas, (ContainerRNA *)&RNA_TransformOrientation,
	NULL,
...
FloatPropertyRNA rna_DisplaySafeAreas_title = {
	...
	-1, "title", 8193, "Title Safe margins",
	"Safe area for text and graphics",
	0, "*",
	PROP_FLOAT, PROP_XYZ | PROP_UNIT_NONE, NULL, 1, {2, 0, 0}, 2,
	NULL, 69140480, NULL, NULL,
	offsetof(DisplaySafeAreas, title), 4, NULL},
...
FloatPropertyRNA rna_DisplaySafeAreas_action = {
	...
	-1, "action", 8193, "Action Safe Margins",
	"Safe area for general elements",
	0, "*",
	PROP_FLOAT, PROP_XYZ | PROP_UNIT_NONE, NULL, 1, {2, 0, 0}, 2,
	NULL, 69140480, NULL, NULL,
	offsetof(DisplaySafeAreas, action), 4, NULL},
...
FloatPropertyRNA rna_DisplaySafeAreas_title_center = {
	...
	-1, "title_center", 8193, "Center Title Safe Margins",
	"Safe area for text and graphics in a different aspect ratio",
	0, "*",
	PROP_FLOAT, PROP_XYZ | PROP_UNIT_NONE, NULL, 1, {2, 0, 0}, 2,
	NULL, 69140480, NULL, NULL,
	offsetof(DisplaySafeAreas, title_center), 4, NULL},
...
FloatPropertyRNA rna_DisplaySafeAreas_action_center = {
	...
	-1, "action_center", 8193, "Center Action Safe Margins",
	"Safe area for general elements in a different aspect ratio",
	0, "*",
	PROP_FLOAT, PROP_XYZ | PROP_UNIT_NONE, NULL, 1, {2, 0, 0}, 2,
	NULL, 69140480, NULL, NULL,
	offsetof(DisplaySafeAreas, action_center), 4, NULL},
...
StructRNA RNA_DisplaySafeAreas = {
	{(ContainerRNA *)&RNA_FFmpegSettings, (ContainerRNA *)&RNA_SelectedUvElement,
	NULL,
	{(PropertyRNA *)&rna_DisplaySafeAreas_rna_properties, (PropertyRNA *)&rna_DisplaySafeAreas_action_center}},
	"DisplaySafeAreas", NULL, NULL, 4, "Safe Areas",
...
static EnumPropertyItem rna_FFmpegSettings_format_items[12] = {
	{0, "MPEG1", 0, "MPEG-1", ""},
	{1, "MPEG2", 0, "MPEG-2", ""},
	{2, "MPEG4", 0, "MPEG-4", ""},
	{3, "AVI", 0, "AVI", ""},
...
EnumPropertyRNA rna_FFmpegSettings_format = {
	...
	0, "*",
	PROP_ENUM, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_FFmpegSettings_codec_settings_update, 67371008, NULL, NULL,
	0, -1, NULL},
	FFmpegSettings_format_get, FFmpegSettings_format_set, NULL, NULL, NULL, NULL, rna_FFmpegSettings_format_items, 11, 0
};

static EnumPropertyItem rna_FFmpegSettings_codec_items[14] = {
	{0, "NONE", 0, "None", ""},
	{1, "MPEG1", 0, "MPEG-1", ""},
	{2, "MPEG2", 0, "MPEG-2", ""},
	{13, "MPEG4", 0, "MPEG-4(divx)", ""},
	{26, "HUFFYUV", 0, "HuffYUV", ""},
	{25, "DV", 0, "DV", ""},
	{28, "H264", 0, "H.264", ""},
	{31, "THEORA", 0, "Theora", ""},
	{22, "FLASH", 0, "Flash Video", ""},
	{34, "FFV1", 0, "FFmpeg video codec #1", ""},
	{56, "QTRLE", 0, "QT rle / QT Animation", ""},
	{100, "DNXHD", 0, "DNxHD", ""},
	{62, "PNG", 0, "PNG", ""},
	{0, NULL, 0, NULL, NULL}
};
...
EnumPropertyRNA rna_FFmpegSettings_codec = {
	...
	rna_FFmpegSettings_codec_settings_update, 67371008, NULL, NULL,
	0, -1, NULL},
	FFmpegSettings_codec_get, FFmpegSettings_codec_set, NULL, NULL, NULL, NULL, rna_FFmpegSettings_codec_items, 13, 0
};

IntPropertyRNA rna_FFmpegSettings_video_bitrate = {
	{(PropertyRNA *)&rna_FFmpegSettings_minrate, (PropertyRNA *)&rna_FFmpegSettings_codec,
	-1, "video_bitrate", 8193, "Bitrate",
	"Video bitrate (kb/s)",
	0, "*",
	PROP_INT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 67371008, NULL, NULL,
...
IntPropertyRNA rna_FFmpegSettings_gopsize = {
	{(PropertyRNA *)&rna_FFmpegSettings_buffersize, (PropertyRNA *)&rna_FFmpegSettings_muxrate,
	-1, "gopsize", 8193, "GOP Size",
...
IntPropertyRNA rna_FFmpegSettings_buffersize = {
	{(PropertyRNA *)&rna_FFmpegSettings_packetsize, (PropertyRNA *)&rna_FFmpegSettings_gopsize,
	-1, "buffersize", 8193, "Buffersize",
...
IntPropertyRNA rna_FFmpegSettings_packetsize = {
	{(PropertyRNA *)&rna_FFmpegSettings_use_autosplit, (PropertyRNA *)&rna_FFmpegSettings_buffersize,
	-1, "packetsize", 8193, "Mux Packet Size",
...
BoolPropertyRNA rna_FFmpegSettings_use_autosplit = {
	{(PropertyRNA *)&rna_FFmpegSettings_use_lossless_output, (PropertyRNA *)&rna_FFmpegSettings_packetsize,
	-1, "use_autosplit", 1, "Autosplit Output",
...
BoolPropertyRNA rna_FFmpegSettings_use_lossless_output = {
	...
	-1, "use_lossless_output", 1, "Lossless Output",
...
static EnumPropertyItem rna_FFmpegSettings_audio_codec_items[9] = {
	{0, "NONE", 0, "None", ""},
	{86016, "MP2", 0, "MP2", ""},
	{86017, "MP3", 0, "MP3", ""},
	{86019, "AC3", 0, "AC3", ""},
...
FloatPropertyRNA rna_FFmpegSettings_audio_volume = {
	...
	-1, "audio_volume", 8193, "Volume",
	"Audio volume",
	0, "Sound",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 67371008, NULL, NULL,
	offsetof(FFMpegCodecData, audio_volume), 4, NULL},
...
StructRNA RNA_FFmpegSettings = {
	{(ContainerRNA *)&RNA_RenderSettings, (ContainerRNA *)&RNA_DisplaySafeAreas,
	NULL,
...
FloatPropertyRNA rna_RenderSettings_motion_blur_shutter = {
	{(PropertyRNA *)&rna_RenderSettings_motion_blur_shutter_curve, (PropertyRNA *)&rna_RenderSettings_motion_blur_samples,
...
PointerPropertyRNA rna_RenderSettings_motion_blur_shutter_curve = {
	{(PropertyRNA *)&rna_RenderSettings_use_border, (PropertyRNA *)&rna_RenderSettings_motion_blur_shutter,
	-1, "motion_blur_shutter_curve", 8388608, "Shutter Curve",
...
BoolPropertyRNA rna_RenderSettings_use_border = {
	{(PropertyRNA *)&rna_RenderSettings_border_min_x, (PropertyRNA *)&rna_RenderSettings_motion_blur_shutter_curve,
...
BoolPropertyRNA rna_RenderSettings_use_free_image_textures = {
	{(PropertyRNA *)&rna_RenderSettings_use_save_buffers, (PropertyRNA *)&rna_RenderSettings_is_movie_format,
...
BoolPropertyRNA rna_RenderSettings_use_stamp = {
	{(PropertyRNA *)&rna_RenderSettings_use_stamp_strip_meta, (PropertyRNA *)&rna_RenderSettings_stamp_note_text,
	-1, "use_stamp", 3, "Stamp Output",
...
BoolPropertyRNA rna_RenderSettings_use_stamp_strip_meta = {
	{(PropertyRNA *)&rna_RenderSettings_stamp_font_size, (PropertyRNA *)&rna_RenderSettings_use_stamp,
	-1, "use_stamp_strip_meta", 3, "Strip Metadata",
...
IntPropertyRNA rna_RenderSettings_stamp_font_size = {
	{(PropertyRNA *)&rna_RenderSettings_stamp_foreground, (PropertyRNA *)&rna_RenderSettings_use_stamp_strip_meta,
...
BoolPropertyRNA rna_RenderSettings_use_single_layer = {
	{(PropertyRNA *)&rna_RenderSettings_views, (PropertyRNA *)&rna_RenderSettings_layers,
...
BoolPropertyRNA rna_RenderSettings_use_multiview = {
	...
	-1, "use_multiview", 3, "Multiple Views",
...
static EnumPropertyItem rna_RenderSettings_views_format_items[3] = {
...
EnumPropertyRNA rna_RenderSettings_views_format = {
	...
	-1, "views_format", 1, "Setup Stereo Mode",
	"",
	0, "*",
	PROP_ENUM, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 252248064, NULL, NULL,
...
IntPropertyRNA rna_RenderSettings_simplify_subdivision_render = {
	...
	-1, "simplify_subdivision_render", 8195, "Simplify Subdivision",
...
FloatPropertyRNA rna_RenderSettings_simplify_child_particles_render = {
	{(PropertyRNA *)&rna_RenderSettings_simplify_shadow_samples, (PropertyRNA *)&rna_RenderSettings_simplify_subdivision_render,
	-1, "simplify_child_particles_render", 8195, "Simplify Child Particles",
	"Global child particles percentage during rendering",
	0, "*",
	PROP_FLOAT, PROP_FACTOR | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Scene_simplify_update, 0, NULL, NULL,
	offsetof(RenderData, simplify_particles_render), 4, NULL},
...
IntPropertyRNA rna_RenderSettings_simplify_shadow_samples = {
	{(PropertyRNA *)&rna_RenderSettings_simplify_ao_sss, (PropertyRNA *)&rna_RenderSettings_simplify_child_particles_render,
...
StructRNA RNA_RenderLayers = {
	{(ContainerRNA *)&RNA_RenderViews, (ContainerRNA *)&RNA_RenderSettings,
	NULL,
...
IntPropertyRNA rna_RenderViews_active_index = {
	...
	-1, "active_index", 3, "Active View Index",
...
PointerPropertyRNA rna_RenderViews_active = {
	...
	-1, "active", 8650753, "Active Render View",
	"Active Render View",
	0, "*",
	PROP_POINTER, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 67371008, NULL, NULL,
...
StructRNA RNA_RenderViews = {
	{(ContainerRNA *)&RNA_BakeSettings, (ContainerRNA *)&RNA_RenderLayers,
	NULL,
	{(PropertyRNA *)&rna_RenderViews_rna_properties, (PropertyRNA *)&rna_RenderViews_active}},
	"RenderViews", NULL, NULL, 4, "Render Views",
...
BoolPropertyRNA rna_BakeSettings_use_pass_ambient_occlusion = {
	...
	-1, "use_pass_ambient_occlusion", 1, "AO",
...
BoolPropertyRNA rna_BakeSettings_use_pass_indirect = {
	...
	-1, "use_pass_indirect", 1, "Indirect",
...
BoolPropertyRNA rna_BakeSettings_use_pass_transmission = {
	...
	-1, "use_pass_transmission", 1, "Transmission",
...
BoolPropertyRNA rna_BakeSettings_use_pass_subsurface = {
	...
	-1, "use_pass_subsurface", 1, "Subsurface",
...
static EnumPropertyItem rna_BakeSettings_pass_filter_items[11] = {
	{0, "NONE", 0, "None", ""},
	{1, "AO", 0, "AO", ""},
	{2, "EMIT", 0, "Emit", ""},
	{64, "DIRECT", 0, "Direct", ""},
...
EnumPropertyRNA rna_BakeSettings_pass_filter = {
	...
	-1, "pass_filter", 2097152, "Pass Filter",
...
StructRNA RNA_BakeSettings = {
	{(ContainerRNA *)&RNA_SceneRenderLayer, (ContainerRNA *)&RNA_RenderViews,
	NULL,
...
BoolPropertyRNA rna_SceneRenderLayer_use_sky = {
	{(PropertyRNA *)&rna_SceneRenderLayer_use_ao, (PropertyRNA *)&rna_SceneRenderLayer_use_ztransp,
	-1, "use_sky", 3, "Sky",
...
BoolPropertyRNA rna_SceneRenderLayer_use_ao = {
	{(PropertyRNA *)&rna_SceneRenderLayer_use_edge_enhance, (PropertyRNA *)&rna_SceneRenderLayer_use_sky,
	-1, "use_ao", 3, "AO",
	...
	rna_Scene_glsl_update, 67371008, NULL, NULL,
	0, -1, NULL},
	SceneRenderLayer_use_ao_get, SceneRenderLayer_use_ao_set, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL
};

BoolPropertyRNA rna_SceneRenderLayer_use_edge_enhance = {
	{(PropertyRNA *)&rna_SceneRenderLayer_use_strand, (PropertyRNA *)&rna_SceneRenderLayer_use_ao,
	-1, "use_edge_enhance", 3, "Edge",
...
StructRNA RNA_Linesets = {
	{(ContainerRNA *)&RNA_GPUSSAOSettings, (ContainerRNA *)&RNA_FreestyleModules,
	NULL,
...
FloatPropertyRNA rna_GPUSSAOSettings_factor = {
	...
	-1, "factor", 8195, "Strength",
	"Strength of the SSAO effect",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 252248064, NULL, NULL,
	offsetof(GPUSSAOSettings, factor), 4, NULL},
...
FloatPropertyRNA rna_GPUSSAOSettings_distance_max = {
	...
	-1, "distance_max", 8195, "Distance",
	"Distance of object that contribute to the SSAO effect",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 252248064, NULL, NULL,
	offsetof(GPUSSAOSettings, distance_max), 4, NULL},
...
FloatPropertyRNA rna_GPUSSAOSettings_attenuation = {
	...
	-1, "attenuation", 8195, "Attenuation",
	"Attenuation constant",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 252248064, NULL, NULL,
	offsetof(GPUSSAOSettings, attenuation), 4, NULL},
...
FloatPropertyRNA rna_GPUSSAOSettings_color = {
	...
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	NULL, 252248064, NULL, NULL,
	offsetof(GPUSSAOSettings, color), 4, NULL},
...
StructRNA RNA_GPUSSAOSettings = {
	{(ContainerRNA *)&RNA_GPUDOFSettings, (ContainerRNA *)&RNA_Linesets,
	NULL,
	{(PropertyRNA *)&rna_GPUSSAOSettings_rna_properties, (PropertyRNA *)&rna_GPUSSAOSettings_color}},
	"GPUSSAOSettings", NULL, NULL, 4, "GPU SSAO",
...
FloatPropertyRNA rna_GPUDOFSettings_focus_distance = {
	...
	-1, "focus_distance", 8195, "Focus distance",
	"Viewport depth of field focus distance",
	0, "*",
	PROP_FLOAT, PROP_DISTANCE | PROP_UNIT_LENGTH, NULL, 0, {0, 0, 0}, 0,
	NULL, 252248064, NULL, NULL,
	offsetof(GPUDOFSettings, focus_distance), 4, NULL},
...
FloatPropertyRNA rna_GPUDOFSettings_sensor = {
	...
	-1, "sensor", 8195, "Sensor",
	"Size of sensor",
	0, "*",
	PROP_FLOAT, PROP_DISTANCE_CAMERA | PROP_UNIT_CAMERA, NULL, 0, {0, 0, 0}, 0,
	NULL, 252248064, NULL, NULL,
	offsetof(GPUDOFSettings, sensor), 4, NULL},
...
FloatPropertyRNA rna_GPUDOFSettings_fstop = {
	...
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 252248064, NULL, NULL,
	offsetof(GPUDOFSettings, fstop), 4, NULL},
	GPUDOFSettings_fstop_get, GPUDOFSettings_fstop_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.1000000015f, 128.0f, 0.0f, FLT_MAX, 10.0f, 1, 0.0f, NULL
};

IntPropertyRNA rna_GPUDOFSettings_blades = {
	{(PropertyRNA *)&rna_GPUDOFSettings_use_high_quality, (PropertyRNA *)&rna_GPUDOFSettings_fstop,
	-1, "blades", 3, "Blades",
...
BoolPropertyRNA rna_GPUDOFSettings_use_high_quality = {
	{(PropertyRNA *)&rna_GPUDOFSettings_is_hq_supported, (PropertyRNA *)&rna_GPUDOFSettings_blades,
	-1, "use_high_quality", 3, "High Quality",
	"Use high quality depth of field",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 252248064, NULL, NULL,
	0, -1, NULL},
	GPUDOFSettings_use_high_quality_get, GPUDOFSettings_use_high_quality_set, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL
};

BoolPropertyRNA rna_GPUDOFSettings_is_hq_supported = {
	{NULL, (PropertyRNA *)&rna_GPUDOFSettings_use_high_quality,
	-1, "is_hq_supported", 2, "High Quality",
	"Use high quality depth of field",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 252248064, NULL, NULL,
	0, -1, NULL},
	GPUDOFSettings_is_hq_supported_get, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL
};

StructRNA RNA_GPUDOFSettings = {
	{(ContainerRNA *)&RNA_GPUFXSettings, (ContainerRNA *)&RNA_GPUSSAOSettings,
	NULL,
	{(PropertyRNA *)&rna_GPUDOFSettings_rna_properties, (PropertyRNA *)&rna_GPUDOFSettings_is_hq_supported}},
	"GPUDOFSettings", NULL, NULL, 4, "GPU DOF",
...
PointerPropertyRNA rna_GPUFXSettings_dof = {
	...
	-1, "dof", 8650752, "Depth Of Field settings",
	"",
	0, "*",
	PROP_POINTER, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
BoolPropertyRNA rna_GPUFXSettings_use_dof = {
	...
	-1, "use_dof", 3, "Depth Of Field",
	"Use depth of field on viewport using the values from active camera",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_GPUFXSettings_fx_update, 252248064, NULL, NULL,
	0, -1, NULL},
...
PointerPropertyRNA rna_GPUFXSettings_ssao = {
	...
	-1, "ssao", 8650752, "Screen Space Ambient Occlusion settings",
	"",
	0, "*",
	PROP_POINTER, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
StructRNA RNA_GPUFXSettings = {
	...
	"GPUFXSettings", NULL, NULL, 4, "GPU FX Settings",
...
StringPropertyRNA rna_SceneRenderView_file_suffix = {
	...
	-1, "file_suffix", 262145, "File Suffix",
...
StringPropertyRNA rna_SceneRenderView_camera_suffix = {
	...
	-1, "camera_suffix", 262145, "Camera Suffix",
...
StructRNA RNA_SceneRenderView = {
	...
	"SceneRenderView", NULL, NULL, 4, "Scene Render View",
