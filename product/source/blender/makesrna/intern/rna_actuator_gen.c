...
BoolPropertyRNA rna_SteeringActuator_lock_z_velocity;
...
int SteeringActuator_lock_z_velocity_get(PointerRNA *ptr)
{
	bSteeringActuator *data = (bSteeringActuator *)(((bActuator *)ptr->data)->data);
	return (((data->flag) & 16) != 0);
}

void SteeringActuator_lock_z_velocity_set(PointerRNA *ptr, int value)
{
	bSteeringActuator *data = (bSteeringActuator *)(((bActuator *)ptr->data)->data);
	if (value) data->flag |= 16;
	else data->flag &= ~16;
...
/* Game Actuator */
static EnumPropertyItem rna_GameActuator_mode_items[7] = {
...
EnumPropertyRNA rna_GameActuator_mode = {
	...
	NULL, 318767104, NULL, NULL,
	0, -1, NULL},
	GameActuator_mode_get, GameActuator_mode_set, NULL, NULL, NULL, NULL, rna_GameActuator_mode_items, 6, 0
};
...
BoolPropertyRNA rna_SteeringActuator_normal_up = {
	{(PropertyRNA *)&rna_SteeringActuator_lock_z_velocity, (PropertyRNA *)&rna_SteeringActuator_facing_axis,
	-1, "normal_up", 3, "N",
...
BoolPropertyRNA rna_SteeringActuator_lock_z_velocity = {
	{NULL, (PropertyRNA *)&rna_SteeringActuator_normal_up,
	-1, "lock_z_velocity", 3, "Lock Z velocity",
	"Disable simulation of linear motion along Z axis",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 318767104, NULL, NULL,
	0, -1, NULL},
	SteeringActuator_lock_z_velocity_get, SteeringActuator_lock_z_velocity_set, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL
};

StructRNA RNA_SteeringActuator = {
	{(ContainerRNA *)&RNA_MouseActuator, (ContainerRNA *)&RNA_ArmatureActuator,
	NULL,
	{(PropertyRNA *)&rna_SteeringActuator_mode, (PropertyRNA *)&rna_SteeringActuator_lock_z_velocity}},
