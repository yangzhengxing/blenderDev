...
int SplineIKConstraint_use_bulge_min_get(PointerRNA *ptr)
{
	bSplineIKConstraint *data = (bSplineIKConstraint *)(((bConstraint *)ptr->data)->data);
	return (((data->flag) & 32) != 0);
}

void SplineIKConstraint_use_bulge_min_set(PointerRNA *ptr, int value)
{
	bSplineIKConstraint *data = (bSplineIKConstraint *)(((bConstraint *)ptr->data)->data);
	if (value) data->flag |= 32;
	else data->flag &= ~32;
...
int SplineIKConstraint_use_bulge_max_get(PointerRNA *ptr)
{
	bSplineIKConstraint *data = (bSplineIKConstraint *)(((bConstraint *)ptr->data)->data);
	return (((data->flag) & 64) != 0);
}

void SplineIKConstraint_use_bulge_max_set(PointerRNA *ptr, int value)
{
	bSplineIKConstraint *data = (bSplineIKConstraint *)(((bConstraint *)ptr->data)->data);
	if (value) data->flag |= 64;
	else data->flag &= ~64;
...
static EnumPropertyItem rna_SplineIKConstraint_xz_scale_mode_items[5] = {
...
FloatPropertyRNA rna_SplineIKConstraint_bulge = {
	...
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Constraint_update, 85590016, NULL, NULL,
	offsetof(bSplineIKConstraint, bulge), 4, NULL},
...
FloatPropertyRNA rna_SplineIKConstraint_bulge_min = {
	...
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Constraint_update, 85590016, NULL, NULL,
	offsetof(bSplineIKConstraint, bulge_min), 4, NULL},
...
FloatPropertyRNA rna_SplineIKConstraint_bulge_max = {
	...
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Constraint_update, 85590016, NULL, NULL,
	offsetof(bSplineIKConstraint, bulge_max), 4, NULL},
...
FloatPropertyRNA rna_SplineIKConstraint_bulge_smooth = {
	...
	PROP_FLOAT, PROP_FACTOR | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Constraint_update, 85590016, NULL, NULL,
	offsetof(bSplineIKConstraint, bulge_smooth), 4, NULL},
