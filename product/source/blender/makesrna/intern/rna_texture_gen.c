...
EnumPropertyRNA rna_VoxelData_hair_data_type;
...
int VoxelData_hair_data_type_get(PointerRNA *ptr)
{
	VoxelData *data = (VoxelData *)(ptr->data);
	return (int)(data->hair_type);
}

void VoxelData_hair_data_type_set(PointerRNA *ptr, int value)
{
	VoxelData *data = (VoxelData *)(ptr->data);
...
PointerPropertyRNA rna_EnvironmentMapTexture_image = {
	...
	0, "*",
	PROP_POINTER, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Envmap_update_generic, 0, NULL, NULL,
	0, -1, NULL},
...
EnumPropertyRNA rna_VoxelData_smoke_data_type = {
	{(PropertyRNA *)&rna_VoxelData_hair_data_type, (PropertyRNA *)&rna_VoxelData_interpolation,
...
static EnumPropertyItem rna_VoxelData_hair_data_type_items[5] = {
	{0, "HAIRDENSITY", 0, "Density", "Use hair density as texture data"},
	{3, "HAIRRESTDENSITY", 0, "Rest Density", "Use hair rest density as texture data"},
	{1, "HAIRVELOCITY", 0, "Velocity", "Use hair velocity as texture data"},
	{2, "HAIRENERGY", 0, "Energy", "Use potential hair energy as texture data"},
	{0, NULL, 0, NULL, NULL}
};

EnumPropertyRNA rna_VoxelData_hair_data_type = {
	{(PropertyRNA *)&rna_VoxelData_extension, (PropertyRNA *)&rna_VoxelData_smoke_data_type,
	-1, "hair_data_type", 3, "Source",
	"Simulation value to be used as a texture",
	0, "*",
	PROP_ENUM, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Texture_voxeldata_update, 0, NULL, NULL,
	0, -1, NULL},
	VoxelData_hair_data_type_get, VoxelData_hair_data_type_set, NULL, NULL, NULL, NULL, rna_VoxelData_hair_data_type_items, 4, 0
};
...
EnumPropertyRNA rna_VoxelData_extension = {
	{(PropertyRNA *)&rna_VoxelData_intensity, (PropertyRNA *)&rna_VoxelData_hair_data_type,
	-1, "extension", 3, "Extension",
...
static EnumPropertyItem rna_VoxelData_file_format_items[6] = {
	...
	{5, "HAIR", 0, "Hair", "Render voxels from a Blender hair simulation"},
	{0, NULL, 0, NULL, NULL}
};
...
EnumPropertyRNA rna_VoxelData_file_format = {
	...
	rna_Texture_voxeldata_update, 0, NULL, NULL,
	0, -1, NULL},
	VoxelData_file_format_get, VoxelData_file_format_set, NULL, NULL, NULL, NULL, rna_VoxelData_file_format_items, 5, 0
};
