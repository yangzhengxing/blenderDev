...
FloatPropertyRNA rna_ThemeTimeline_time_keyframe;
FloatPropertyRNA rna_ThemeTimeline_time_grease_pencil;
...
FloatPropertyRNA rna_UserPreferencesView_rotation_angle;
...
EnumPropertyRNA rna_UserPreferencesView_view_frame_type;
IntPropertyRNA rna_UserPreferencesView_view_frame_keyframes;
FloatPropertyRNA rna_UserPreferencesView_view_frame_seconds;
...
IntPropertyRNA rna_UserPreferencesEdit_node_margin;
...
FloatPropertyRNA rna_UserPreferencesInput_ndof_deadzone;
...
FloatPropertyRNA rna_UserPreferencesSystem_pixel_size;
StringPropertyRNA rna_UserPreferencesSystem_font_path_ui;
StringPropertyRNA rna_UserPreferencesSystem_font_path_ui_mono;
...
EnumPropertyRNA rna_UserPreferencesSystem_compute_device_type;
EnumPropertyRNA rna_UserPreferencesSystem_compute_device;
...
void ThemeUserInterface_widget_emboss_set(PointerRNA *ptr, const float values[4])
{
	...
	for (i = 0; i < 4; i++) {
		data->widget_emboss[i] = FTOCHAR(values[i]);
	}
}
...
void ThemeView3D_clipping_border_3d_set(PointerRNA *ptr, const float values[4])
{
	...
	for (i = 0; i < 4; i++) {
		data->clipping_border_3d[i] = FTOCHAR(values[i]);
	}
}
...
void ThemeView3D_gp_vertex_set(PointerRNA *ptr, const float values[3])
{
	...
	for (i = 0; i < 3; i++) {
		data->gp_vertex[i] = FTOCHAR(values[i]);
	}
}
...
void ThemeView3D_gp_vertex_select_set(PointerRNA *ptr, const float values[3])
{
	...
	for (i = 0; i < 3; i++) {
		data->gp_vertex_select[i] = FTOCHAR(values[i]);
	}
}
...
void ThemeView3D_text_grease_pencil_set(PointerRNA *ptr, const float values[3])
{
	...
	for (i = 0; i < 3; i++) {
		data->time_gp_keyframe[i] = FTOCHAR(values[i]);
	}
}
...
void ThemeView3D_text_keyframe_set(PointerRNA *ptr, const float values[3])
{
	...
	for (i = 0; i < 3; i++) {
		data->time_keyframe[i] = FTOCHAR(values[i]);
	}
}
...
void ThemeImageEditor_metadatabg_set(PointerRNA *ptr, const float values[3])
{
	...
	for (i = 0; i < 3; i++) {
		data->metadatabg[i] = FTOCHAR(values[i]);
	}
}
...
void ThemeImageEditor_metadatatext_set(PointerRNA *ptr, const float values[3])
{
	...
	for (i = 0; i < 3; i++) {
		data->metadatatext[i] = FTOCHAR(values[i]);
	}
}
...
void ThemeSequenceEditor_text_strip_set(PointerRNA *ptr, const float values[3])
{
	...
	for (i = 0; i < 3; i++) {
		data->text_strip[i] = FTOCHAR(values[i]);
	}
}
...
void ThemeTimeline_time_keyframe_get(PointerRNA *ptr, float values[3])
{
	ThemeSpace *data = (ThemeSpace *)(ptr->data);
	unsigned int i;
...
void ThemeTimeline_time_keyframe_set(PointerRNA *ptr, const float values[3])
{
	ThemeSpace *data = (ThemeSpace *)(ptr->data);
	unsigned int i;
...
void ThemeTimeline_time_grease_pencil_get(PointerRNA *ptr, float values[3])
{
	ThemeSpace *data = (ThemeSpace *)(ptr->data);
	unsigned int i;
...
void ThemeTimeline_time_grease_pencil_set(PointerRNA *ptr, const float values[3])
{
	ThemeSpace *data = (ThemeSpace *)(ptr->data);
	unsigned int i;
...
float UserPreferencesView_rotation_angle_get(PointerRNA *ptr)
{
	UserDef *data = (UserDef *)(ptr->data);
	return (float)(data->pad_rot_angle);
}

void UserPreferencesView_rotation_angle_set(PointerRNA *ptr, float value)
{
	UserDef *data = (UserDef *)(ptr->data);
...
int UserPreferencesView_view_frame_type_get(PointerRNA *ptr)
{
	UserDef *data = (UserDef *)(ptr->data);
	return (int)(data->view_frame_type);
}

void UserPreferencesView_view_frame_type_set(PointerRNA *ptr, int value)
{
	UserDef *data = (UserDef *)(ptr->data);
	data->view_frame_type = value;
}

int UserPreferencesView_view_frame_keyframes_get(PointerRNA *ptr)
{
	UserDef *data = (UserDef *)(ptr->data);
	return (int)(data->view_frame_keyframes);
}

void UserPreferencesView_view_frame_keyframes_set(PointerRNA *ptr, int value)
{
	UserDef *data = (UserDef *)(ptr->data);
	data->view_frame_keyframes = CLAMPIS(value, 1, 500);
}

float UserPreferencesView_view_frame_seconds_get(PointerRNA *ptr)
{
	UserDef *data = (UserDef *)(ptr->data);
	return (float)(data->view_frame_seconds);
}

void UserPreferencesView_view_frame_seconds_set(PointerRNA *ptr, float value)
{
	UserDef *data = (UserDef *)(ptr->data);
...
int UserPreferencesEdit_node_margin_get(PointerRNA *ptr)
{
	UserDef *data = (UserDef *)(ptr->data);
	return (int)(data->node_margin);
}

void UserPreferencesEdit_node_margin_set(PointerRNA *ptr, int value)
{
	UserDef *data = (UserDef *)(ptr->data);
...
float UserPreferencesInput_ndof_deadzone_get(PointerRNA *ptr)
{
	UserDef *data = (UserDef *)(ptr->data);
	return (float)(data->ndof_deadzone);
}

void UserPreferencesInput_ndof_deadzone_set(PointerRNA *ptr, float value)
{
	UserDef *data = (UserDef *)(ptr->data);
...
float UserPreferencesSystem_pixel_size_get(PointerRNA *ptr)
{
	UserDef *data = (UserDef *)(ptr->data);
...
void UserPreferencesSystem_font_path_ui_mono_get(PointerRNA *ptr, char *value)
{
	UserDef *data = (UserDef *)(ptr->data);
	BLI_strncpy(value, data->font_path_ui_mono, 1024);
}

int UserPreferencesSystem_font_path_ui_mono_length(PointerRNA *ptr)
{
	UserDef *data = (UserDef *)(ptr->data);
	return strlen(data->font_path_ui_mono);
}

void UserPreferencesSystem_font_path_ui_mono_set(PointerRNA *ptr, const char *value)
{
	UserDef *data = (UserDef *)(ptr->data);
...
int UserPreferencesSystem_compute_device_type_get(PointerRNA *ptr)
{
	UserDef *data = (UserDef *)(ptr->data);
	return (int)(data->compute_device_type);
}

void UserPreferencesSystem_compute_device_type_set(PointerRNA *ptr, int value)
{
	UserDef *data = (UserDef *)(ptr->data);
	data->compute_device_type = value;
}

int UserPreferencesSystem_compute_device_get(PointerRNA *ptr)
{
	return rna_userdef_compute_device_get(ptr);
}

void UserPreferencesSystem_compute_device_set(PointerRNA *ptr, int value)
{
	UserDef *data = (UserDef *)(ptr->data);
	data->compute_device_id = value;
}
...
FloatPropertyRNA rna_ThemeUserInterface_icon_alpha = {
	{(PropertyRNA *)&rna_ThemeUserInterface_widget_emboss, (PropertyRNA *)&rna_ThemeUserInterface_icon_file,
...
FloatPropertyRNA rna_ThemeUserInterface_widget_emboss = {
	...
	-1, "widget_emboss", 8195, "Widget Emboss",
...
FloatPropertyRNA rna_ThemeUserInterface_axis_x = {
	{(PropertyRNA *)&rna_ThemeUserInterface_axis_y, (PropertyRNA *)&rna_ThemeUserInterface_widget_emboss,
...
FloatPropertyRNA rna_ThemeView3D_clipping_border_3d = {
	...
	-1, "clipping_border_3d", 8195, "Clipping Border",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {4, 0, 0}, 4,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeView3D_gp_vertex = {
	...
	-1, "gp_vertex", 8195, "Grease Pencil Vertex",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeView3D_gp_vertex_select = {
	...
	-1, "gp_vertex_select", 8195, "Grease Pencil Vertex Select",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_userdef_update, 0, NULL, NULL,
...
IntPropertyRNA rna_ThemeView3D_gp_vertex_size = {
	...
	-1, "gp_vertex_size", 8195, "Grease Pencil Vertex Size",
	"",
	0, "*",
	PROP_INT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeView3D_text_grease_pencil = {
	...
	-1, "text_grease_pencil", 8195, "Grease Pencil Keyframe",
...
FloatPropertyRNA rna_ThemeView3D_object_grouped_active = {
	{(PropertyRNA *)&rna_ThemeView3D_text_keyframe, (PropertyRNA *)&rna_ThemeView3D_object_grouped,
...
FloatPropertyRNA rna_ThemeView3D_text_keyframe = {
	{(PropertyRNA *)&rna_ThemeView3D_camera, (PropertyRNA *)&rna_ThemeView3D_object_grouped_active,
	-1, "text_keyframe", 8195, "Object Keyframe",
...
FloatPropertyRNA rna_ThemeView3D_empty = {
	{(PropertyRNA *)&rna_ThemeView3D_lamp, (PropertyRNA *)&rna_ThemeView3D_camera,
	-1, "empty", 8195, "Empty",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
...
FloatPropertyRNA rna_ThemeView3D_speaker = {
	{(PropertyRNA *)&rna_ThemeView3D_vertex, (PropertyRNA *)&rna_ThemeView3D_lamp,
...
FloatPropertyRNA rna_ThemeImageEditor_metadatabg = {
	...
	-1, "metadatabg", 8195, "Metadata Background",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeImageEditor_metadatatext = {
	...
	-1, "metadatatext", 8195, "Metadata Text",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_userdef_update, 0, NULL, NULL,
...
FloatPropertyRNA rna_ThemeTimeline_frame_current = {
	{(PropertyRNA *)&rna_ThemeTimeline_time_keyframe, (PropertyRNA *)&rna_ThemeTimeline_grid,
	-1, "frame_current", 8195, "Current Frame",
	"",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
...
static float rna_ThemeTimeline_time_keyframe_default[3] = {
	0.0f,
	0.0f,
	0.0f
};
...
FloatPropertyRNA rna_ThemeTimeline_time_keyframe = {
	{(PropertyRNA *)&rna_ThemeTimeline_time_grease_pencil, (PropertyRNA *)&rna_ThemeTimeline_frame_current,
	-1, "time_keyframe", 8195, "Keyframe",
	"Base color for keyframe indicator lines",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_userdef_update, 0, NULL, NULL,
	offsetof(ThemeSpace, time_keyframe), 2, NULL},
	NULL, NULL, ThemeTimeline_time_keyframe_get, ThemeTimeline_time_keyframe_set, NULL, NULL, NULL, NULL, NULL, NULL, 0.0f, 1.0f, 0.0f, 1.0f, 10.0f, 3, 0.0f, rna_ThemeTimeline_time_keyframe_default
};

static float rna_ThemeTimeline_time_grease_pencil_default[3] = {
	0.0f,
	0.0f,
	0.0f
};
...
FloatPropertyRNA rna_ThemeTimeline_time_grease_pencil = {
	{NULL, (PropertyRNA *)&rna_ThemeTimeline_time_keyframe,
	-1, "time_grease_pencil", 8195, "Grease Pencil",
	"Color of Grease Pencil keyframes",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_userdef_update, 0, NULL, NULL,
	offsetof(ThemeSpace, time_gp_keyframe), 2, NULL},
	NULL, NULL, ThemeTimeline_time_grease_pencil_get, ThemeTimeline_time_grease_pencil_set, NULL, NULL, NULL, NULL, NULL, NULL, 0.0f, 1.0f, 0.0f, 1.0f, 10.0f, 3, 0.0f, rna_ThemeTimeline_time_grease_pencil_default
};

StructRNA RNA_ThemeTimeline = {
	{(ContainerRNA *)&RNA_ThemeNodeEditor, (ContainerRNA *)&RNA_ThemeTextEditor,
	NULL,
	{(PropertyRNA *)&rna_ThemeTimeline_rna_properties, (PropertyRNA *)&rna_ThemeTimeline_time_grease_pencil}},
...
StructRNA RNA_Addons = {
	...
	"Addons", NULL, NULL, 0, "User Add-ons",
...
FloatPropertyRNA rna_UserPreferencesView_rotation_angle = {
	...
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
	offsetof(UserDef, pad_rot_angle), 4, NULL},
	UserPreferencesView_rotation_angle_get, UserPreferencesView_rotation_angle_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0f, 90.0f, 0.0f, 90.0f, 10.0f, 3, 0.0f, NULL
};
...
EnumPropertyRNA rna_UserPreferencesView_timecode_style = {
	{(PropertyRNA *)&rna_UserPreferencesView_view_frame_type, (PropertyRNA *)&rna_UserPreferencesView_view2d_grid_spacing_min,
...
static EnumPropertyItem rna_UserPreferencesView_view_frame_type_items[4] = {
...
EnumPropertyRNA rna_UserPreferencesView_view_frame_type = {
	{(PropertyRNA *)&rna_UserPreferencesView_view_frame_keyframes, (PropertyRNA *)&rna_UserPreferencesView_timecode_style,
	-1, "view_frame_type", 3, "Zoom To Frame Type",
	"How zooming to frame focuses around current frame",
	0, "*",
	PROP_ENUM, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
	0, -1, NULL},
	UserPreferencesView_view_frame_type_get, UserPreferencesView_view_frame_type_set, NULL, NULL, NULL, NULL, rna_UserPreferencesView_view_frame_type_items, 3, 0
};

IntPropertyRNA rna_UserPreferencesView_view_frame_keyframes = {
	{(PropertyRNA *)&rna_UserPreferencesView_view_frame_seconds, (PropertyRNA *)&rna_UserPreferencesView_view_frame_type,
	-1, "view_frame_keyframes", 8195, "Zoom Keyframes",
	"Keyframes around cursor that we zoom around",
	0, "*",
	PROP_INT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
	offsetof(UserDef, view_frame_keyframes), 0, NULL},
	UserPreferencesView_view_frame_keyframes_get, UserPreferencesView_view_frame_keyframes_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL,
	1, 500, 1, 500, 1, 0, NULL
};

FloatPropertyRNA rna_UserPreferencesView_view_frame_seconds = {
	{NULL, (PropertyRNA *)&rna_UserPreferencesView_view_frame_keyframes,
	-1, "view_frame_seconds", 8195, "Zoom Seconds",
	"Seconds around cursor that we zoom around",
	0, "*",
	PROP_FLOAT, PROP_TIME | PROP_UNIT_TIME, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
	offsetof(UserDef, view_frame_seconds), 4, NULL},
	UserPreferencesView_view_frame_seconds_get, UserPreferencesView_view_frame_seconds_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0f, 10000.0f, 0.0f, 10000.0f, 10.0f, 3, 0.0f, NULL
};

StructRNA RNA_UserPreferencesView = {
	{(ContainerRNA *)&RNA_UserPreferencesEdit, (ContainerRNA *)&RNA_PathCompareCollection,
	NULL,
	{(PropertyRNA *)&rna_UserPreferencesView_rna_properties, (PropertyRNA *)&rna_UserPreferencesView_view_frame_seconds}},
...
BoolPropertyRNA rna_UserPreferencesEdit_use_duplicate_particle = {
	{(PropertyRNA *)&rna_UserPreferencesEdit_node_margin, (PropertyRNA *)&rna_UserPreferencesEdit_use_duplicate_action,
...
IntPropertyRNA rna_UserPreferencesEdit_node_margin = {
	{NULL, (PropertyRNA *)&rna_UserPreferencesEdit_use_duplicate_particle,
	-1, "node_margin", 8195, "Auto-offset Margin",
	"Minimum distance between nodes for Auto-offsetting nodes",
	0, "*",
	PROP_INT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_userdef_update, 0, NULL, NULL,
	offsetof(UserDef, node_margin), 2, NULL},
	UserPreferencesEdit_node_margin_get, UserPreferencesEdit_node_margin_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL,
	0, 255, 0, 255, 1, 0, NULL
};
...
StructRNA RNA_UserPreferencesEdit = {
	...
	NULL,
	{(PropertyRNA *)&rna_UserPreferencesEdit_rna_properties, (PropertyRNA *)&rna_UserPreferencesEdit_node_margin}},
...
FloatPropertyRNA rna_UserPreferencesInput_ndof_orbit_sensitivity = {
	{(PropertyRNA *)&rna_UserPreferencesInput_ndof_deadzone, (PropertyRNA *)&rna_UserPreferencesInput_ndof_sensitivity,
...
FloatPropertyRNA rna_UserPreferencesInput_ndof_deadzone = {
	{(PropertyRNA *)&rna_UserPreferencesInput_ndof_pan_yz_swap_axis, (PropertyRNA *)&rna_UserPreferencesInput_ndof_orbit_sensitivity,
	-1, "ndof_deadzone", 8195, "Deadzone",
	"Deadzone of the 3D Mouse",
	0, "*",
	PROP_FLOAT, PROP_FACTOR | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_userdef_ndof_deadzone_update, 0, NULL, NULL,
	offsetof(UserDef, ndof_deadzone), 4, NULL},
	UserPreferencesInput_ndof_deadzone_get, UserPreferencesInput_ndof_deadzone_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0f, 1.0f, 0.0f, 1.0f, 10.0f, 3, 0.0f, NULL
};

BoolPropertyRNA rna_UserPreferencesInput_ndof_pan_yz_swap_axis = {
	{(PropertyRNA *)&rna_UserPreferencesInput_ndof_zoom_invert, (PropertyRNA *)&rna_UserPreferencesInput_ndof_deadzone,
...
EnumPropertyRNA rna_UserPreferencesSystem_virtual_pixel_mode = {
	{(PropertyRNA *)&rna_UserPreferencesSystem_pixel_size, (PropertyRNA *)&rna_UserPreferencesSystem_dpi,
...
FloatPropertyRNA rna_UserPreferencesSystem_pixel_size = {
	{(PropertyRNA *)&rna_UserPreferencesSystem_font_path_ui, (PropertyRNA *)&rna_UserPreferencesSystem_virtual_pixel_mode,
	-1, "pixel_size", 8194, "Pixel Size",
	"",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
	offsetof(UserDef, pixelsize), 4, NULL},
	UserPreferencesSystem_pixel_size_get, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, -10000.0f, 10000.0f, -FLT_MAX, FLT_MAX, 10.0f, 3, 0.0f, NULL
};

StringPropertyRNA rna_UserPreferencesSystem_font_path_ui = {
	{(PropertyRNA *)&rna_UserPreferencesSystem_font_path_ui_mono, (PropertyRNA *)&rna_UserPreferencesSystem_pixel_size,
...
StringPropertyRNA rna_UserPreferencesSystem_font_path_ui_mono = {
	{(PropertyRNA *)&rna_UserPreferencesSystem_scrollback, (PropertyRNA *)&rna_UserPreferencesSystem_font_path_ui,
	-1, "font_path_ui_mono", 262145, "Mono-space Font",
	"Path to interface mono-space Font",
	0, "*",
	PROP_STRING, PROP_FILEPATH | PROP_UNIT_NONE, NULL, 0, {1024, 0, 0}, 0,
	rna_userdef_language_update, 33554432, NULL, NULL,
	0, -1, NULL},
	UserPreferencesSystem_font_path_ui_mono_get, UserPreferencesSystem_font_path_ui_mono_length, UserPreferencesSystem_font_path_ui_mono_set, NULL, NULL, NULL, 1024, ""
};

IntPropertyRNA rna_UserPreferencesSystem_scrollback = {
	{(PropertyRNA *)&rna_UserPreferencesSystem_author, (PropertyRNA *)&rna_UserPreferencesSystem_font_path_ui_mono,
...
EnumPropertyRNA rna_UserPreferencesSystem_language = {
	...
	rna_userdef_language_update, 33554432, NULL, NULL,
	0, -1, NULL},
	UserPreferencesSystem_language_get, UserPreferencesSystem_language_set, rna_lang_enum_properties_itemf, NULL, NULL, NULL, rna_UserPreferencesSystem_language_items, 1, 0
};
...
EnumPropertyRNA rna_UserPreferencesSystem_image_draw_method = {
	{(PropertyRNA *)&rna_UserPreferencesSystem_anisotropic_filter, (PropertyRNA *)&rna_UserPreferencesSystem_use_gpu_mipmap,
...
EnumPropertyRNA rna_UserPreferencesSystem_anisotropic_filter = {
	{(PropertyRNA *)&rna_UserPreferencesSystem_gl_texture_limit, (PropertyRNA *)&rna_UserPreferencesSystem_image_draw_method,
...
static EnumPropertyItem rna_UserPreferencesSystem_audio_device_items[4] = {
...
EnumPropertyRNA rna_UserPreferencesSystem_audio_device = {
	...
	rna_UserDef_audio_update, 0, NULL, NULL,
	0, -1, NULL},
	UserPreferencesSystem_audio_device_get, UserPreferencesSystem_audio_device_set, rna_userdef_audio_device_itemf, NULL, NULL, NULL, rna_UserPreferencesSystem_audio_device_items, 3, 0
};
...
BoolPropertyRNA rna_UserPreferencesSystem_use_region_overlap = {
	{(PropertyRNA *)&rna_UserPreferencesSystem_compute_device_type, (PropertyRNA *)&rna_UserPreferencesSystem_multi_sample,
...
static EnumPropertyItem rna_UserPreferencesSystem_compute_device_type_items[4] = {
	{0, "NONE", 0, "None", "Don\'t use compute device"},
	{2, "CUDA", 0, "CUDA", "Use CUDA for GPU acceleration"},
	{1, "OPENCL", 0, "OpenCL", "Use OpenCL for GPU acceleration"},
	{0, NULL, 0, NULL, NULL}
};

EnumPropertyRNA rna_UserPreferencesSystem_compute_device_type = {
	{(PropertyRNA *)&rna_UserPreferencesSystem_compute_device, (PropertyRNA *)&rna_UserPreferencesSystem_use_region_overlap,
	-1, "compute_device_type", 16777219, "Compute Device Type",
	"Device to use for computation (rendering with Cycles)",
	0, "*",
	PROP_ENUM, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 252313600, NULL, NULL,
	0, -1, NULL},
	UserPreferencesSystem_compute_device_type_get, UserPreferencesSystem_compute_device_type_set, rna_userdef_compute_device_type_itemf, NULL, NULL, NULL, rna_UserPreferencesSystem_compute_device_type_items, 3, 0
};

static EnumPropertyItem rna_UserPreferencesSystem_compute_device_items[2] = {
	{0, "CPU", 0, "CPU", ""},
	{0, NULL, 0, NULL, NULL}
};

EnumPropertyRNA rna_UserPreferencesSystem_compute_device = {
	{NULL, (PropertyRNA *)&rna_UserPreferencesSystem_compute_device_type,
	-1, "compute_device", 16777219, "Compute Device",
	"Device to use for computation",
	0, "*",
	PROP_ENUM, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
	0, -1, NULL},
	UserPreferencesSystem_compute_device_get, UserPreferencesSystem_compute_device_set, rna_userdef_compute_device_itemf, NULL, NULL, NULL, rna_UserPreferencesSystem_compute_device_items, 1, 0
};

StructRNA RNA_UserPreferencesSystem = {
	{(ContainerRNA *)&RNA_Addon, (ContainerRNA *)&RNA_UserPreferencesFilePaths,
	NULL,
	{(PropertyRNA *)&rna_UserPreferencesSystem_rna_properties, (PropertyRNA *)&rna_UserPreferencesSystem_compute_device}},
