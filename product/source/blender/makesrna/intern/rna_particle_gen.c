...
int ParticleSettingsTextureSlot_use_map_kink_amp_get(PointerRNA *ptr)
{
	MTex *data = (MTex *)(ptr->data);
	return (((data->mapto) & 4096) != 0);
}

void ParticleSettingsTextureSlot_use_map_kink_amp_set(PointerRNA *ptr, int value)
{
	MTex *data = (MTex *)(ptr->data);
...
int ParticleSettingsTextureSlot_use_map_kink_freq_get(PointerRNA *ptr)
{
	MTex *data = (MTex *)(ptr->data);
	return (((data->mapto) & 256) != 0);
}

void ParticleSettingsTextureSlot_use_map_kink_freq_set(PointerRNA *ptr, int value)
{
	MTex *data = (MTex *)(ptr->data);
...
int ParticleSettings_show_guide_hairs_get(PointerRNA *ptr)
{
	ParticleSettings *data = (ParticleSettings *)(ptr->data);
	return (((data->draw) & 131072) != 0);
}

void ParticleSettings_show_guide_hairs_set(PointerRNA *ptr, int value)
{
	ParticleSettings *data = (ParticleSettings *)(ptr->data);
...
int ParticleSettings_show_hair_grid_get(PointerRNA *ptr)
{
	ParticleSettings *data = (ParticleSettings *)(ptr->data);
	return (((data->draw) & 262144) != 0);
}

void ParticleSettings_show_hair_grid_set(PointerRNA *ptr, int value)
{
	ParticleSettings *data = (ParticleSettings *)(ptr->data);
...
int ParticleSettings_use_clump_curve_get(PointerRNA *ptr)
{
	ParticleSettings *data = (ParticleSettings *)(ptr->data);
	return (((data->child_flag) & 2) != 0);
}

void ParticleSettings_use_clump_curve_set(PointerRNA *ptr, int value)
{
	ParticleSettings *data = (ParticleSettings *)(ptr->data);
...
int ParticleSettings_use_clump_noise_get(PointerRNA *ptr)
{
	ParticleSettings *data = (ParticleSettings *)(ptr->data);
	return (((data->child_flag) & 1) != 0);
}

void ParticleSettings_use_clump_noise_set(PointerRNA *ptr, int value)
{
	ParticleSettings *data = (ParticleSettings *)(ptr->data);
...
int ParticleSettings_use_roughness_curve_get(PointerRNA *ptr)
{
	ParticleSettings *data = (ParticleSettings *)(ptr->data);
	return (((data->child_flag) & 4) != 0);
}

void ParticleSettings_use_roughness_curve_set(PointerRNA *ptr, int value)
{
	ParticleSettings *data = (ParticleSettings *)(ptr->data);
...
BoolPropertyRNA rna_ParticleSettingsTextureSlot_use_map_kink_amp = {
	...
	-1, "use_map_kink_amp", 3, "Kink Amplitude",
...
BoolPropertyRNA rna_ParticleSettingsTextureSlot_use_map_kink_freq = {
	...
	-1, "use_map_kink_freq", 3, "Kink Frequency",
...
FloatPropertyRNA rna_ParticleSettingsTextureSlot_kink_amp_factor = {
	...
	-1, "kink_amp_factor", 8195, "Kink Amplitude Factor",
	"Amount texture affects child kink amplitude",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Particle_redo_child, 0, NULL, NULL,
	offsetof(MTex, kinkampfac), 4, NULL},
...
FloatPropertyRNA rna_ParticleSettingsTextureSlot_kink_freq_factor = {
	...
	-1, "kink_freq_factor", 8195, "Kink Frequency Factor",
...
FloatPropertyRNA rna_ParticleSettingsTextureSlot_rough_factor = {
	{NULL, (PropertyRNA *)&rna_ParticleSettingsTextureSlot_kink_freq_factor,
...
BoolPropertyRNA rna_ParticleSettings_show_guide_hairs = {
	...
	-1, "show_guide_hairs", 3, "Guide Hairs",
	"Show guide hairs",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Particle_redo, 0, NULL, NULL,
...
BoolPropertyRNA rna_ParticleSettings_show_hair_grid = {
	...
	-1, "show_hair_grid", 3, "Guide Hairs",
...
FloatPropertyRNA rna_ParticleSettings_bending_random = {
	...
	-1, "bending_random", 8195, "Random Bending Stiffness",
	"Random stiffness of hairs",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Particle_cloth_update, 0, NULL, NULL,
	offsetof(ParticleSettings, bending_random), 4, NULL},
...
static EnumPropertyItem rna_ParticleSettings_kink_items[7] = {
	{0, "NO", 0, "Nothing", ""},
	{1, "CURL", 0, "Curl", ""},
	{2, "RADIAL", 0, "Radial", ""},
	{3, "WAVE", 0, "Wave", ""},
...
BoolPropertyRNA rna_ParticleSettings_use_clump_curve = {
	...
	-1, "use_clump_curve", 3, "Use Clump Curve",
	"Use a curve to define clump tapering",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_ParticleSettings_use_clump_curve_update, 0, NULL, NULL,
	0, -1, NULL},
...
PointerPropertyRNA rna_ParticleSettings_clump_curve = {
	...
	-1, "clump_curve", 8388608, "Clump Curve",
...
BoolPropertyRNA rna_ParticleSettings_use_clump_noise = {
	...
	-1, "use_clump_noise", 3, "Use Clump Noise",
...
FloatPropertyRNA rna_ParticleSettings_clump_noise_size = {
	...
	-1, "clump_noise_size", 8195, "Clump Noise Size",
	"Size of clump noise",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Particle_redo_child, 0, NULL, NULL,
	offsetof(ParticleSettings, clump_noise_size), 4, NULL},
...
FloatPropertyRNA rna_ParticleSettings_kink_amplitude_random = {
	...
	-1, "kink_amplitude_random", 8195, "Amplitude Random",
	"Random variation of the amplitude",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Particle_redo_child, 0, NULL, NULL,
	offsetof(ParticleSettings, kink_amp_random), 4, NULL},
...
IntPropertyRNA rna_ParticleSettings_kink_extra_steps = {
	...
	-1, "kink_extra_steps", 8195, "Extra Steps",
...
FloatPropertyRNA rna_ParticleSettings_kink_axis_random = {
	...
	-1, "kink_axis_random", 8195, "Axis Random",
	"Random variation of the orientation",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Particle_redo_child, 0, NULL, NULL,
	offsetof(ParticleSettings, kink_axis_random), 4, NULL},
...
BoolPropertyRNA rna_ParticleSettings_use_roughness_curve = {
	...
	-1, "use_roughness_curve", 3, "Use Roughness Curve",
	"Use a curve to define roughness",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_ParticleSettings_use_roughness_curve_update, 0, NULL, NULL,
	0, -1, NULL},
...
PointerPropertyRNA rna_ParticleSettings_roughness_curve = {
	...
	-1, "roughness_curve", 8388608, "Roughness Curve",
