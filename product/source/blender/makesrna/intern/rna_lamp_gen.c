...
BoolPropertyRNA rna_SunLamp_show_shadow_box;
...
int SunLamp_show_shadow_box_get(PointerRNA *ptr)
{
	Lamp *data = (Lamp *)(ptr->data);
	return (((data->mode) & 262144) != 0);
}

void SunLamp_show_shadow_box_set(PointerRNA *ptr, int value)
{
	Lamp *data = (Lamp *)(ptr->data);
...
FloatPropertyRNA rna_Lamp_distance = {
	...
	Lamp_distance_get, Lamp_distance_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0f, 1000.0f, 0.0f, 2147483648.0f, 1.0f, 3, 0.0f, NULL
};
...
FloatPropertyRNA rna_SunLamp_shadow_frustum_size = {
	{(PropertyRNA *)&rna_SunLamp_show_shadow_box, (PropertyRNA *)&rna_SunLamp_sky,
...
BoolPropertyRNA rna_SunLamp_show_shadow_box = {
	{NULL, (PropertyRNA *)&rna_SunLamp_shadow_frustum_size,
	-1, "show_shadow_box", 3, "Show Shadow Box",
	"Draw a box in 3D view to visualize which objects are contained in it",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Lamp_draw_update, 0, NULL, NULL,
	0, -1, NULL},
	SunLamp_show_shadow_box_get, SunLamp_show_shadow_box_set, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL
};

StructRNA RNA_SunLamp = {
	{(ContainerRNA *)&RNA_LampSkySettings, (ContainerRNA *)&RNA_SpotLamp,
	NULL,
	{(PropertyRNA *)&rna_SunLamp_use_shadow, (PropertyRNA *)&rna_SunLamp_show_shadow_box}},
