...
int KeyingSet_use_insertkey_override_needed_get(PointerRNA *ptr)
{
	KeyingSet *data = (KeyingSet *)(ptr->data);
	return (((data->keyingoverride) & 1) != 0);
}

void KeyingSet_use_insertkey_override_needed_set(PointerRNA *ptr, int value)
{
	KeyingSet *data = (KeyingSet *)(ptr->data);
...
int KeyingSet_use_insertkey_override_visual_get(PointerRNA *ptr)
{
	KeyingSet *data = (KeyingSet *)(ptr->data);
	return (((data->keyingoverride) & 2) != 0);
}

void KeyingSet_use_insertkey_override_visual_set(PointerRNA *ptr, int value)
{
	KeyingSet *data = (KeyingSet *)(ptr->data);
...
int KeyingSet_use_insertkey_override_xyz_to_rgb_get(PointerRNA *ptr)
{
	KeyingSet *data = (KeyingSet *)(ptr->data);
	return (((data->keyingoverride) & 32) != 0);
}

void KeyingSet_use_insertkey_override_xyz_to_rgb_set(PointerRNA *ptr, int value)
{
	KeyingSet *data = (KeyingSet *)(ptr->data);
...
int KeyingSet_use_insertkey_needed_get(PointerRNA *ptr)
{
	KeyingSet *data = (KeyingSet *)(ptr->data);
	return (((data->keyingflag) & 1) != 0);
}

void KeyingSet_use_insertkey_needed_set(PointerRNA *ptr, int value)
{
	KeyingSet *data = (KeyingSet *)(ptr->data);
...
int KeyingSet_use_insertkey_visual_get(PointerRNA *ptr)
{
	KeyingSet *data = (KeyingSet *)(ptr->data);
	return (((data->keyingflag) & 2) != 0);
}

void KeyingSet_use_insertkey_visual_set(PointerRNA *ptr, int value)
{
	KeyingSet *data = (KeyingSet *)(ptr->data);
...
int KeyingSet_use_insertkey_xyz_to_rgb_get(PointerRNA *ptr)
{
	KeyingSet *data = (KeyingSet *)(ptr->data);
	return (((data->keyingflag) & 32) != 0);
}

void KeyingSet_use_insertkey_xyz_to_rgb_set(PointerRNA *ptr, int value)
{
	KeyingSet *data = (KeyingSet *)(ptr->data);
...
int KeyingSetPath_use_insertkey_override_needed_get(PointerRNA *ptr)
{
	KS_Path *data = (KS_Path *)(ptr->data);
	return (((data->keyingoverride) & 1) != 0);
}

void KeyingSetPath_use_insertkey_override_needed_set(PointerRNA *ptr, int value)
{
	KS_Path *data = (KS_Path *)(ptr->data);
	if (value) data->keyingoverride |= 1;
	else data->keyingoverride &= ~1;
...
int KeyingSetPath_use_insertkey_override_visual_get(PointerRNA *ptr)
{
	KS_Path *data = (KS_Path *)(ptr->data);
	return (((data->keyingoverride) & 2) != 0);
}

void KeyingSetPath_use_insertkey_override_visual_set(PointerRNA *ptr, int value)
{
	KS_Path *data = (KS_Path *)(ptr->data);
	if (value) data->keyingoverride |= 2;
	else data->keyingoverride &= ~2;
...
int KeyingSetPath_use_insertkey_override_xyz_to_rgb_get(PointerRNA *ptr)
{
	KS_Path *data = (KS_Path *)(ptr->data);
	return (((data->keyingoverride) & 32) != 0);
}

void KeyingSetPath_use_insertkey_override_xyz_to_rgb_set(PointerRNA *ptr, int value)
{
	KS_Path *data = (KS_Path *)(ptr->data);
	if (value) data->keyingoverride |= 32;
	else data->keyingoverride &= ~32;
...
int KeyingSetPath_use_insertkey_needed_get(PointerRNA *ptr)
{
	KS_Path *data = (KS_Path *)(ptr->data);
	return (((data->keyingflag) & 1) != 0);
}

void KeyingSetPath_use_insertkey_needed_set(PointerRNA *ptr, int value)
{
	KS_Path *data = (KS_Path *)(ptr->data);
	if (value) data->keyingflag |= 1;
	else data->keyingflag &= ~1;
...
int KeyingSetPath_use_insertkey_visual_get(PointerRNA *ptr)
{
	KS_Path *data = (KS_Path *)(ptr->data);
	return (((data->keyingflag) & 2) != 0);
}

void KeyingSetPath_use_insertkey_visual_set(PointerRNA *ptr, int value)
{
	KS_Path *data = (KS_Path *)(ptr->data);
	if (value) data->keyingflag |= 2;
	else data->keyingflag &= ~2;
...
int KeyingSetPath_use_insertkey_xyz_to_rgb_get(PointerRNA *ptr)
{
	KS_Path *data = (KS_Path *)(ptr->data);
	return (((data->keyingflag) & 32) != 0);
}

void KeyingSetPath_use_insertkey_xyz_to_rgb_set(PointerRNA *ptr, int value)
{
	KS_Path *data = (KS_Path *)(ptr->data);
	if (value) data->keyingflag |= 32;
	else data->keyingflag &= ~32;
...
FunctionRNA rna_AnimDataDrivers_from_existing_func = {
	{(FunctionRNA *)&rna_AnimDataDrivers_find_func, NULL,
	NULL,
...
StructRNA RNA_AnimDataDrivers = {
	...
	NULL,
	NULL,
	{(FunctionRNA *)&rna_AnimDataDrivers_from_existing_func, (FunctionRNA *)&rna_AnimDataDrivers_find_func}
};
...
BoolPropertyRNA rna_KeyingSet_use_insertkey_override_needed = {
	...
	-1, "use_insertkey_override_needed", 3, "Override Insert Keyframes Default- Only Needed",
...
BoolPropertyRNA rna_KeyingSet_use_insertkey_override_visual = {
	...
	-1, "use_insertkey_override_visual", 3, "Override Insert Keyframes Default - Visual",
...
BoolPropertyRNA rna_KeyingSet_use_insertkey_override_xyz_to_rgb = {
	...
	-1, "use_insertkey_override_xyz_to_rgb", 3, "Override F-Curve Colors - XYZ to RGB",
...
BoolPropertyRNA rna_KeyingSet_use_insertkey_needed = {
	...
	-1, "use_insertkey_needed", 3, "Insert Keyframes - Only Needed",
...
BoolPropertyRNA rna_KeyingSet_use_insertkey_visual = {
	...
	-1, "use_insertkey_visual", 3, "Insert Keyframes - Visual",
...
BoolPropertyRNA rna_KeyingSet_use_insertkey_xyz_to_rgb = {
	...
	-1, "use_insertkey_xyz_to_rgb", 3, "F-Curve Colors - XYZ to RGB",
...
static EnumPropertyItem rna_KeyingSetPath_id_type_items[33] = {
...
EnumPropertyRNA rna_KeyingSetPath_id_type = {
	...
	0, -1, NULL},
	KeyingSetPath_id_type_get, KeyingSetPath_id_type_set, NULL, NULL, NULL, NULL, rna_KeyingSetPath_id_type_items, 32, 16975
};
