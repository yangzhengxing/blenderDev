...
int SequenceProxy_use_overwrite_get(PointerRNA *ptr)
{
	StripProxy *data = (StripProxy *)(ptr->data);
	return !(((data->build_flags) & 1) != 0);
}

void SequenceProxy_use_overwrite_set(PointerRNA *ptr, int value)
{
	StripProxy *data = (StripProxy *)(ptr->data);
...
int SequenceProxy_use_proxy_custom_directory_get(PointerRNA *ptr)
{
	StripProxy *data = (StripProxy *)(ptr->data);
	return (((data->storage) & 4) != 0);
}

void SequenceProxy_use_proxy_custom_directory_set(PointerRNA *ptr, int value)
{
	StripProxy *data = (StripProxy *)(ptr->data);
...
int SequenceProxy_use_proxy_custom_file_get(PointerRNA *ptr)
{
	StripProxy *data = (StripProxy *)(ptr->data);
	return (((data->storage) & 2) != 0);
}

void SequenceProxy_use_proxy_custom_file_set(PointerRNA *ptr, int value)
{
	StripProxy *data = (StripProxy *)(ptr->data);
...
int ImageSequence_use_multiview_get(PointerRNA *ptr)
{
	Sequence *data = (Sequence *)(ptr->data);
	return (((data->flag) & 536870912) != 0);
}

void ImageSequence_use_multiview_set(PointerRNA *ptr, int value)
{
	Sequence *data = (Sequence *)(ptr->data);
...
int SceneSequence_use_sequence_get(PointerRNA *ptr)
{
	Sequence *data = (Sequence *)(ptr->data);
	return (((data->flag) & 1073741824) != 0);
}

void SceneSequence_use_sequence_set(PointerRNA *ptr, int value)
{
	Sequence *data = (Sequence *)(ptr->data);
...
int SceneSequence_use_grease_pencil_get(PointerRNA *ptr)
{
	Sequence *data = (Sequence *)(ptr->data);
	return !(((data->flag) & 268435456) != 0);
}

void SceneSequence_use_grease_pencil_set(PointerRNA *ptr, int value)
{
	Sequence *data = (Sequence *)(ptr->data);
...
int MovieSequence_use_multiview_get(PointerRNA *ptr)
{
	Sequence *data = (Sequence *)(ptr->data);
	return (((data->flag) & 536870912) != 0);
}

void MovieSequence_use_multiview_set(PointerRNA *ptr, int value)
{
	Sequence *data = (Sequence *)(ptr->data);
	if (value) data->flag |= 536870912;
	else data->flag &= ~536870912;
...
{
	TextVars *data = (TextVars *)(((Sequence *)ptr->data)->effectdata);
	data->text_size = CLAMPIS(value, 0, INT_MAX);
}
...
int TextSequence_use_shadow_get(PointerRNA *ptr)
{
	TextVars *data = (TextVars *)(((Sequence *)ptr->data)->effectdata);
	return (((data->flag) & 1) != 0);
}

void TextSequence_use_shadow_set(PointerRNA *ptr, int value)
{
	TextVars *data = (TextVars *)(((Sequence *)ptr->data)->effectdata);
	if (value) data->flag |= 1;
	else data->flag &= ~1;
...
static EnumPropertyItem rna_Sequence_type_items[25] = {
	{0, "IMAGE", 0, "Image", ""},
	{1, "META", 0, "Meta", ""},
	{2, "SCENE", 0, "Scene", ""},
	{3, "MOVIE", 0, "Movie", ""},
...
EnumPropertyRNA rna_Sequence_type = {
	...
	rna_Sequence_update, 67502080, NULL, NULL,
	0, -1, NULL},
	Sequence_type_get, NULL, NULL, NULL, NULL, NULL, rna_Sequence_type_items, 24, 0
};
...
static EnumPropertyItem rna_SequenceModifiers_new_type_items[8] = {
...
static EnumPropertyItem rna_SequenceEditor_proxy_storage_items[3] = {
...
EnumPropertyRNA rna_SequenceEditor_proxy_storage = {
	...
	-1, "proxy_storage", 3, "Proxy Storage",
	"How to store proxies for this project",
	0, "*",
	PROP_ENUM, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_SequenceEditor_update_cache, 252706816, NULL, NULL,
	0, -1, NULL},
...
StringPropertyRNA rna_SequenceEditor_proxy_dir = {
	...
	-1, "proxy_dir", 262145, "Proxy Directory",
	"",
	0, "*",
...
static EnumPropertyItem rna_Sequences_new_effect_type_items[18] = {
	{8, "CROSS", 0, "Cross", ""},
	{9, "ADD", 0, "Add", ""},
	{10, "SUBTRACT", 0, "Subtract", ""},
	{11, "ALPHA_OVER", 0, "Alpha Over", ""},
...
EnumPropertyRNA rna_Sequences_new_effect_type = {
	...
	NULL, 0, NULL, NULL,
	0, -1, NULL},
	NULL, NULL, NULL, NULL, NULL, NULL, rna_Sequences_new_effect_type_items, 17, 8
};
...
BoolPropertyRNA rna_ImageSequence_use_multiview = {
	...
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Sequence_views_format_update, 67502080, NULL, NULL,
	0, -1, NULL},
	ImageSequence_use_multiview_get, ImageSequence_use_multiview_set, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL
};

static EnumPropertyItem rna_ImageSequence_views_format_items[3] = {
...
EnumPropertyRNA rna_ImageSequence_views_format = {
	...
	0, "*",
	PROP_ENUM, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Sequence_views_format_update, 171114496, NULL, NULL,
	0, -1, NULL},
...
static EnumPropertyItem rna_MovieSequence_views_format_items[3] = {
	{0, "INDIVIDUAL", 0, "Individual", "Individual files for each view with the prefix as defined by the scene views"},
	{1, "STEREO_3D", 0, "Stereo 3D", "Single file with an encoded stereo pair"},
	{0, NULL, 0, NULL, NULL}
};
...
PointerPropertyRNA rna_SoundSequence_sound = {
	...
	0, "*",
	PROP_POINTER, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Sequence_sound_update, 67502080, NULL, NULL,
	0, -1, NULL},
...
/* Text Sequence */
IntPropertyRNA rna_TextSequence_input_count = {
	{(PropertyRNA *)&rna_TextSequence_font_size, NULL,
	-1, "input_count", 2, "input_count",
	"",
	0, "*",
	PROP_INT, PROP_UNSIGNED | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
...
IntPropertyRNA rna_TextSequence_font_size = {
	{(PropertyRNA *)&rna_TextSequence_location, (PropertyRNA *)&rna_TextSequence_input_count,
	-1, "font_size", 8195, "Size",
	"Size of the text",
	0, "*",
	PROP_INT, PROP_UNSIGNED | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Sequence_update, 67502080, NULL, NULL,
...
FloatPropertyRNA rna_TextSequence_location = {
	{(PropertyRNA *)&rna_TextSequence_wrap_width, (PropertyRNA *)&rna_TextSequence_font_size,
	-1, "location", 8195, "Location",
	"Location of the text",
	0, "*",
	PROP_FLOAT, PROP_XYZ | PROP_UNIT_NONE, NULL, 1, {2, 0, 0}, 2,
	rna_Sequence_update, 67502080, NULL, NULL,
	offsetof(TextVars, loc), 4, NULL},
...
FloatPropertyRNA rna_TextSequence_wrap_width = {
	...
	-1, "wrap_width", 8195, "Wrap Width",
	"Word wrap width as factor, zero disables",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Sequence_update, 67502080, NULL, NULL,
	offsetof(TextVars, wrap_width), 4, NULL},
...
static EnumPropertyItem rna_TextSequence_align_x_items[4] = {
	{0, "LEFT", 0, "Left", ""},
	{1, "CENTER", 0, "Center", ""},
	{2, "RIGHT", 0, "Right", ""},
	{0, NULL, 0, NULL, NULL}
...
static EnumPropertyItem rna_TextSequence_align_y_items[4] = {
	{0, "TOP", 0, "Top", ""},
	{1, "CENTER", 0, "Center", ""},
	{2, "BOTTOM", 0, "Bottom", ""},
	{0, NULL, 0, NULL, NULL}
...
StructRNA RNA_TextSequence = {
	{(ContainerRNA *)&RNA_SequenceModifier, (ContainerRNA *)&RNA_GaussianBlurSequence,
	NULL,
	{(PropertyRNA *)&rna_TextSequence_input_count, (PropertyRNA *)&rna_TextSequence_use_shadow}},
	"TextSequence", NULL, NULL, 4, "Text Sequence",
...
static EnumPropertyItem rna_SequenceModifier_type_items[8] = {
	{1, "COLOR_BALANCE", 0, "Color Balance", ""},
	{2, "CURVES", 0, "Curves", ""},
	{3, "HUE_CORRECT", 0, "Hue Correct", ""},
	{4, "BRIGHT_CONTRAST", 0, "Bright/Contrast", ""},
...
static EnumPropertyItem rna_SequenceModifier_mask_time_items[3] = {
...
StructRNA RNA_SequenceModifier = {
	{(ContainerRNA *)&RNA_ColorBalanceModifier, (ContainerRNA *)&RNA_TextSequence,
	NULL,
...
FloatPropertyRNA rna_WhiteBalanceModifier_white_value = {
	{NULL, NULL,
	-1, "white_value", 8195, "White value",
	"This color defines white in the strip",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_SequenceModifier_update, 67502080, NULL, NULL,
	offsetof(WhiteBalanceModifierData, white_value), 4, NULL},
...
StructRNA RNA_WhiteBalanceModifier = {
	...
	"WhiteBalanceModifier", NULL, NULL, 4, "WhiteBalanceModifier",
...
static EnumPropertyItem rna_SequencerTonemapModifierData_tonemap_type_items[3] = {
...
FloatPropertyRNA rna_SequencerTonemapModifierData_key = {
	...
	PROP_FLOAT, PROP_FACTOR | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_SequenceModifier_update, 67502080, NULL, NULL,
	offsetof(SequencerTonemapModifierData, key), 4, NULL},
...
FloatPropertyRNA rna_SequencerTonemapModifierData_offset = {
	...
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_SequenceModifier_update, 67502080, NULL, NULL,
	offsetof(SequencerTonemapModifierData, offset), 4, NULL},
...
FloatPropertyRNA rna_SequencerTonemapModifierData_gamma = {
	...
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_SequenceModifier_update, 67502080, NULL, NULL,
	offsetof(SequencerTonemapModifierData, gamma), 4, NULL},
...
FloatPropertyRNA rna_SequencerTonemapModifierData_intensity = {
	...
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_SequenceModifier_update, 67502080, NULL, NULL,
	offsetof(SequencerTonemapModifierData, intensity), 4, NULL},
...
FloatPropertyRNA rna_SequencerTonemapModifierData_contrast = {
	...
	PROP_FLOAT, PROP_FACTOR | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_SequenceModifier_update, 67502080, NULL, NULL,
	offsetof(SequencerTonemapModifierData, contrast), 4, NULL},
...
FloatPropertyRNA rna_SequencerTonemapModifierData_adaptation = {
	...
	PROP_FLOAT, PROP_FACTOR | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_SequenceModifier_update, 67502080, NULL, NULL,
	offsetof(SequencerTonemapModifierData, adaptation), 4, NULL},
...
FloatPropertyRNA rna_SequencerTonemapModifierData_correction = {
	...
	PROP_FLOAT, PROP_FACTOR | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_SequenceModifier_update, 67502080, NULL, NULL,
	offsetof(SequencerTonemapModifierData, correction), 4, NULL},
...
StructRNA RNA_SequencerTonemapModifierData = {
	...
	"SequencerTonemapModifierData", NULL, NULL, 4, "SequencerTonemapModifierData",
