...
BoolPropertyRNA rna_Speaker_relative;
...
/* Speaker */
BoolPropertyRNA rna_Speaker_muted = {
	{(PropertyRNA *)&rna_Speaker_relative, NULL,
	-1, "muted", 1, "Mute",
	"Mute the speaker",
	0, "Sound",
...
BoolPropertyRNA rna_Speaker_relative = {
	{(PropertyRNA *)&rna_Speaker_sound, (PropertyRNA *)&rna_Speaker_muted,
	-1, "relative", 2, "Relative",
	"Whether the source is relative to the camera or not",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
	0, -1, NULL},
	Speaker_relative_get, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL
};

PointerPropertyRNA rna_Speaker_sound = {
	{(PropertyRNA *)&rna_Speaker_volume_max, (PropertyRNA *)&rna_Speaker_relative,
...
FloatPropertyRNA rna_Speaker_volume_max = {
	...
	-1, "volume_max", 8193, "Maximum Volume",
	"Maximum volume, no matter how near the object is",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
	offsetof(Speaker, volume_max), 4, NULL},
...
FloatPropertyRNA rna_Speaker_volume_min = {
	...
	-1, "volume_min", 8193, "Minimum Volume",
	"Minimum volume, no matter how far away the object is",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
	offsetof(Speaker, volume_min), 4, NULL},
...
FloatPropertyRNA rna_Speaker_distance_reference = {
	...
	-1, "distance_reference", 8193, "Reference Distance",
	"Reference distance at which volume is 100 %",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
	offsetof(Speaker, distance_reference), 4, NULL},
...
FloatPropertyRNA rna_Speaker_cone_angle_outer = {
	...
	-1, "cone_angle_outer", 8193, "Outer Cone Angle",
	...
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
	offsetof(Speaker, cone_angle_outer), 4, NULL},
...
FloatPropertyRNA rna_Speaker_cone_angle_inner = {
	...
	-1, "cone_angle_inner", 8193, "Inner Cone Angle",
	"Angle of the inner cone, in degrees, inside the cone the volume is 100 %",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
	offsetof(Speaker, cone_angle_inner), 4, NULL},
...
FloatPropertyRNA rna_Speaker_cone_volume_outer = {
	...
	-1, "cone_volume_outer", 8193, "Outer Cone Volume",
	"Volume outside the outer cone",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
	offsetof(Speaker, cone_volume_outer), 4, NULL},
...
FloatPropertyRNA rna_Speaker_volume = {
	...
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
	offsetof(Speaker, volume), 4, NULL},
