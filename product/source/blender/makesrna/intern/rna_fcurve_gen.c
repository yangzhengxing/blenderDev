...
BoolPropertyRNA rna_Driver_show_debug_info;
...
{
	DriverTarget *data = (DriverTarget *)(ptr->data);
	BLI_strncpy_utf8(value, data->pchan_name, 32);
}
...
{
	DriverTarget *data = (DriverTarget *)(ptr->data);
	BLI_strncpy_utf8(data->pchan_name, value, 32);
}
...
void FModifierStepped_frame_start_set(PointerRNA *ptr, float value)
{
	...
	data->start_frame = CLAMPIS(value, prop_clamp_min, prop_clamp_max);}
...
void FModifierStepped_frame_end_set(PointerRNA *ptr, float value)
{
	...
	data->end_frame = CLAMPIS(value, prop_clamp_min, prop_clamp_max);}
...
{
	return rna_FKeyframe_points_insert(_self, frame, value, options);
}
...
void rna_FKeyframe_points_remove(struct FCurve *_self, ReportList *reports, struct PointerRNA *keyframe, int fast);
...
EnumPropertyRNA rna_FCurve_extrapolation = {
	...
	rna_FCurve_update_data, 239468545, NULL, NULL,
	0, -1, NULL},
...
EnumPropertyRNA rna_FCurve_color_mode = {
	...
	NULL, 234881024, NULL, NULL,
	0, -1, NULL},
	FCurve_color_mode_get, FCurve_color_mode_set, NULL, NULL, NULL, NULL, rna_FCurve_color_mode_items, 3, 0
};
...
BoolPropertyRNA rna_FCurve_hide = {
	{(PropertyRNA *)&rna_FCurve_is_valid, (PropertyRNA *)&rna_FCurve_mute,
	-1, "hide", 3, "Hide",
...
BoolPropertyRNA rna_FCurve_is_valid = {
	{(PropertyRNA *)&rna_FCurve_sampled_points, (PropertyRNA *)&rna_FCurve_hide,
	-1, "is_valid", 3, "Valid",
...
StructRNA RNA_FCurveKeyframePoints = {
	...
	"FCurveKeyframePoints", NULL, NULL, 4, "Keyframe Points",
...
PointerPropertyRNA rna_FCurveModifiers_active = {
	...
	-1, "active", 8388609, "Active F-Curve Modifier",
...
EnumPropertyRNA rna_FCurveModifiers_new_type = {
	...
	NULL, 0, NULL, NULL,
	0, -1, NULL},
	NULL, NULL, NULL, NULL, NULL, NULL, rna_FCurveModifiers_new_type_items, 9, 1
};
...
StructRNA RNA_FCurveModifiers = {
	...
	"FCurveModifiers", NULL, NULL, 4, "F-Curve Modifiers",
...
static EnumPropertyItem rna_Keyframe_handle_left_type_items[6] = {
	{0, "FREE", 0, "Free", ""},
	{2, "VECTOR", 0, "Vector", ""},
	{3, "ALIGNED", 0, "Aligned", ""},
	{1, "AUTO", 0, "Automatic", ""},
...
EnumPropertyRNA rna_Keyframe_handle_left_type = {
	...
	-1, "handle_left_type", 3, "Left Handle Type",
	"Handle types",
	0, "*",
	PROP_ENUM, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 239534080, NULL, NULL,
...
static EnumPropertyItem rna_Keyframe_handle_right_type_items[6] = {
	{0, "FREE", 0, "Free", ""},
	{2, "VECTOR", 0, "Vector", ""},
	{3, "ALIGNED", 0, "Aligned", ""},
	{1, "AUTO", 0, "Automatic", ""},
...
EnumPropertyRNA rna_Keyframe_handle_right_type = {
	...
	-1, "handle_right_type", 3, "Right Handle Type",
	"Handle types",
	0, "*",
	PROP_ENUM, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 239534080, NULL, NULL,
...
static EnumPropertyItem rna_Keyframe_interpolation_items[17] = {
...
static EnumPropertyItem rna_Keyframe_type_items[5] = {
	{0, "KEYFRAME", 0, "Keyframe", "Normal keyframe - e.g. for key poses"},
	{2, "BREAKDOWN", 0, "Breakdown", "A breakdown pose - e.g. for transitions between key poses"},
	{1, "EXTREME", 0, "Extreme", "An \'extreme\' pose, or some other purpose as needed"},
	{3, "JITTER", 0, "Jitter", "A filler or baked keyframe for keying on ones, or some other purpose as needed"},
	{0, NULL, 0, NULL, NULL}
};
...
EnumPropertyRNA rna_Keyframe_type = {
	...
	NULL, 239534080, NULL, NULL,
	0, -1, NULL},
	Keyframe_type_get, Keyframe_type_set, NULL, NULL, NULL, NULL, rna_Keyframe_type_items, 4, 0
};

static EnumPropertyItem rna_Keyframe_easing_items[5] = {
...
FloatPropertyRNA rna_Keyframe_back = {
	...
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 239534080, NULL, NULL,
	offsetof(BezTriple, back), 4, NULL},
...
FloatPropertyRNA rna_Keyframe_amplitude = {
	...
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 239534080, NULL, NULL,
	offsetof(BezTriple, amplitude), 4, NULL},
...
FloatPropertyRNA rna_Keyframe_period = {
	...
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 239534080, NULL, NULL,
	offsetof(BezTriple, period), 4, NULL},
...
StructRNA RNA_FCurveSample = {
	...
	"FCurveSample", NULL, NULL, 4, "F-Curve Sample",
...
static EnumPropertyItem rna_DriverTarget_id_type_items[33] = {
...
EnumPropertyRNA rna_DriverTarget_id_type = {
	...
	0, -1, NULL},
	DriverTarget_id_type_get, DriverTarget_id_type_set, NULL, NULL, NULL, NULL, rna_DriverTarget_id_type_items, 32, 16975
};
...
StringPropertyRNA rna_DriverTarget_bone_target = {
	...
	-1, "bone_target", 262145, "Bone Name",
	"Name of PoseBone to use as target",
	0, "*",
	PROP_STRING, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {32, 0, 0}, 0,
	rna_DriverTarget_update_data, 0, NULL, NULL,
	0, -1, NULL},
	DriverTarget_bone_target_get, DriverTarget_bone_target_length, DriverTarget_bone_target_set, NULL, NULL, NULL, 32, ""
};
...
static EnumPropertyItem rna_DriverTarget_transform_space_items[4] = {
...
EnumPropertyRNA rna_DriverTarget_transform_space = {
	...
	-1, "transform_space", 3, "Transform Space",
...
StructRNA RNA_DriverTarget = {
	...
	"DriverTarget", NULL, NULL, 4, "Driver Target",
...
CollectionPropertyRNA rna_DriverVariable_targets = {
	{NULL, (PropertyRNA *)&rna_DriverVariable_type,
...
StructRNA RNA_DriverVariable = {
	...
	NULL,
	{(PropertyRNA *)&rna_DriverVariable_rna_properties, (PropertyRNA *)&rna_DriverVariable_targets}},
	"DriverVariable", NULL, NULL, 4, "Driver Variable",
...
CollectionPropertyRNA rna_Driver_variables = {
	{(PropertyRNA *)&rna_Driver_show_debug_info, (PropertyRNA *)&rna_Driver_expression,
...
BoolPropertyRNA rna_Driver_show_debug_info = {
	...
	NULL, 0, NULL, NULL,
	0, -1, NULL},
	Driver_show_debug_info_get, Driver_show_debug_info_set, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL
};

BoolPropertyRNA rna_Driver_is_valid = {
	{NULL, (PropertyRNA *)&rna_Driver_show_debug_info,
...
StructRNA RNA_Driver = {
	...
	NULL,
	{(PropertyRNA *)&rna_Driver_rna_properties, (PropertyRNA *)&rna_Driver_is_valid}},
	"Driver", NULL, NULL, 4, "Driver",
...
StructRNA RNA_ChannelDriverVariables = {
	...
	"ChannelDriverVariables", NULL, NULL, 4, "ChannelDriver Variables",
...
EnumPropertyRNA rna_FModifier_type = {
	...
	NULL, 0, NULL, NULL,
	0, -1, NULL},
	FModifier_type_get, NULL, NULL, NULL, NULL, NULL, rna_FModifier_type_items, 9, 0
};
...
BoolPropertyRNA rna_FModifier_use_restricted_range = {
	...
	-1, "use_restricted_range", 4099, "Restrict Frame Range",
...
FloatPropertyRNA rna_FModifier_blend_in = {
	...
	-1, "blend_in", 8195, "Blend In",
	"Number of frames from start frame for influence to take effect",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 239534080, NULL, NULL,
	offsetof(FModifier, blendin), 4, NULL},
...
FloatPropertyRNA rna_FModifier_blend_out = {
	...
	-1, "blend_out", 8195, "Blend Out",
	"Number of frames from end frame for influence to fade out",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 239534080, NULL, NULL,
	offsetof(FModifier, blendout), 4, NULL},
...
BoolPropertyRNA rna_FModifier_use_influence = {
	...
	-1, "use_influence", 4099, "Use Influence",
...
FloatPropertyRNA rna_FModifier_influence = {
	...
	NULL, 239534080, NULL, NULL,
	offsetof(FModifier, influence), 4, NULL},
...
StructRNA RNA_FModifier = {
	...
	"FModifier", NULL, NULL, 4, "F-Modifier",
...
EnumPropertyRNA rna_FModifierGenerator_mode = {
	...
	0, "*",
	PROP_ENUM, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_FModifier_verify_data_update, 239468545, NULL, NULL,
	0, -1, NULL},
...
StructRNA RNA_FModifierGenerator = {
	...
	"FModifierGenerator", NULL, NULL, 4, "Generator F-Modifier",
...
StructRNA RNA_FModifierFunctionGenerator = {
	...
	"FModifierFunctionGenerator", NULL, NULL, 4, "Built-In Function F-Modifier",
...
StructRNA RNA_FModifierEnvelope = {
	...
	"FModifierEnvelope", NULL, NULL, 4, "Envelope F-Modifier",
...
StructRNA RNA_FModifierEnvelopeControlPoints = {
	...
	"FModifierEnvelopeControlPoints", NULL, NULL, 4, "Control Points",
	"Control points defining the shape of the envelope",
	"*", 17,
	NULL, (PropertyRNA *)&rna_FModifierEnvelopeControlPoints_rna_properties,
	NULL,
...
StructRNA RNA_FModifierEnvelopeControlPoint = {
	...
	"FModifierEnvelopeControlPoint", NULL, NULL, 4, "Envelope Control Point",
...
StructRNA RNA_FModifierCycles = {
	...
	"FModifierCycles", NULL, NULL, 4, "Cycles F-Modifier",
...
StructRNA RNA_FModifierPython = {
	...
	NULL,
	{NULL, NULL}},
	"FModifierPython", NULL, NULL, 4, "Python F-Modifier",
...
StructRNA RNA_FModifierLimits = {
	...
	"FModifierLimits", NULL, NULL, 4, "Limit F-Modifier",
...
FloatPropertyRNA rna_FModifierNoise_offset = {
	...
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 239468545, NULL, NULL,
	offsetof(FMod_Noise, offset), 4, NULL},
...
StructRNA RNA_FModifierNoise = {
	...
	"FModifierNoise", NULL, NULL, 4, "Noise F-Modifier",
...
StructRNA RNA_FModifierStepped = {
	...
	"FModifierStepped", NULL, NULL, 4, "Stepped Interpolation F-Modifier",
