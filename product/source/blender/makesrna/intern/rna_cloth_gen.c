...
FloatPropertyRNA rna_ClothSettings_vel_damping;
BoolPropertyRNA rna_ClothSettings_use_pin_cloth;
...
BoolPropertyRNA rna_ClothSettings_use_stiffness_scale;
...
FloatPropertyRNA rna_ClothCollisionSettings_repel_force;
FloatPropertyRNA rna_ClothCollisionSettings_distance_repel;
...
{
	ClothSimSettings *data = (ClothSimSettings *)(ptr->data);
	return (float)(data->vel_damping);
}

void ClothSettings_vel_damping_set(PointerRNA *ptr, float value)
{
	ClothSimSettings *data = (ClothSimSettings *)(ptr->data);
	data->vel_damping = CLAMPIS(value, 0.0f, 1.0f);
}
...
{
	ClothSimSettings *data = (ClothSimSettings *)(ptr->data);
	data->stepsPerFrame = CLAMPIS(value, 1, 80);
}
...
{
	ClothSimSettings *data = (ClothSimSettings *)(ptr->data);
	data->shrink_min = CLAMPIS(value, 0.0f, 1.0f);
}
...
{
	ClothSimSettings *data = (ClothSimSettings *)(ptr->data);
	data->shrink_max = CLAMPIS(value, 0.0f, 1.0f);
}
...
static EnumPropertyItem rna_ClothSolverResult_status_items[5] = {
...
IntPropertyRNA rna_ClothSolverResult_max_iterations = {
	...
	-1, "max_iterations", 2, "Maximum Iterations",
...
IntPropertyRNA rna_ClothSolverResult_min_iterations = {
	...
	-1, "min_iterations", 2, "Minimum Iterations",
...
FloatPropertyRNA rna_ClothSolverResult_avg_iterations = {
	...
	-1, "avg_iterations", 2, "Average Iterations",
...
StructRNA RNA_ClothSolverResult = {
	...
	"ClothSolverResult", NULL, NULL, 4, "Solver Result",
...
FloatPropertyRNA rna_ClothSettings_density_target = {
	...
	-1, "density_target", 8195, "Target Density",
	"Maximum density of hair",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_cloth_update, 0, NULL, NULL,
	offsetof(ClothSimSettings, density_target), 4, NULL},
...
FloatPropertyRNA rna_ClothSettings_density_strength = {
	...
	-1, "density_strength", 8195, "Target Density Strength",
	"Influence of target density on the simulation",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_cloth_update, 0, NULL, NULL,
	offsetof(ClothSimSettings, density_strength), 4, NULL},
...
FloatPropertyRNA rna_ClothSettings_air_damping = {
	{(PropertyRNA *)&rna_ClothSettings_vel_damping, (PropertyRNA *)&rna_ClothSettings_gravity,
...
FloatPropertyRNA rna_ClothSettings_vel_damping = {
	{(PropertyRNA *)&rna_ClothSettings_use_pin_cloth, (PropertyRNA *)&rna_ClothSettings_air_damping,
	-1, "vel_damping", 8195, "Velocity Damping",
	"Damp velocity to help cloth reach the resting position faster (1.0 = no damping, 0.0 = fully dampened)",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_cloth_update, 0, NULL, NULL,
	offsetof(ClothSimSettings, vel_damping), 4, NULL},
	ClothSettings_vel_damping_get, ClothSettings_vel_damping_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0f, 1.0f, 0.0f, 1.0f, 10.0f, 3, 0.0f, NULL
};

BoolPropertyRNA rna_ClothSettings_use_pin_cloth = {
	{(PropertyRNA *)&rna_ClothSettings_pin_stiffness, (PropertyRNA *)&rna_ClothSettings_vel_damping,
	-1, "use_pin_cloth", 1, "Pin Cloth",
	"Enable pinning of cloth vertices to other objects/positions",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_cloth_pinning_changed, 0, NULL, NULL,
	0, -1, NULL},
	ClothSettings_use_pin_cloth_get, ClothSettings_use_pin_cloth_set, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL
};

FloatPropertyRNA rna_ClothSettings_pin_stiffness = {
	{(PropertyRNA *)&rna_ClothSettings_quality, (PropertyRNA *)&rna_ClothSettings_use_pin_cloth,
...
IntPropertyRNA rna_ClothSettings_quality = {
	{(PropertyRNA *)&rna_ClothSettings_vertex_group_shrink, (PropertyRNA *)&rna_ClothSettings_pin_stiffness,
...
StringPropertyRNA rna_ClothSettings_vertex_group_shrink = {
	{(PropertyRNA *)&rna_ClothSettings_shrink_min, (PropertyRNA *)&rna_ClothSettings_quality,
	-1, "vertex_group_shrink", 262145, "Shrink Vertex Group",
...
FloatPropertyRNA rna_ClothSettings_shrink_min = {
	...
	-1, "shrink_min", 8195, "Shrink Factor Min",
	"Min amount to shrink cloth by",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_cloth_update, 0, NULL, NULL,
	offsetof(ClothSimSettings, shrink_min), 4, NULL},
...
FloatPropertyRNA rna_ClothSettings_shrink_max = {
	...
	-1, "shrink_max", 8195, "Shrink Factor Max",
	"Max amount to shrink cloth by",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_cloth_update, 0, NULL, NULL,
	offsetof(ClothSimSettings, shrink_max), 4, NULL},
...
FloatPropertyRNA rna_ClothSettings_voxel_cell_size = {
	{(PropertyRNA *)&rna_ClothSettings_use_stiffness_scale, (PropertyRNA *)&rna_ClothSettings_shrink_max,
	-1, "voxel_cell_size", 8195, "Voxel Grid Cell Size",
	"Size of the voxel grid cells for interaction effects",
	0, "*",
	PROP_FLOAT, PROP_UNSIGNED | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_cloth_update, 0, NULL, NULL,
	offsetof(ClothSimSettings, voxel_cell_size), 4, NULL},
...
BoolPropertyRNA rna_ClothSettings_use_stiffness_scale = {
	{(PropertyRNA *)&rna_ClothSettings_spring_damping, (PropertyRNA *)&rna_ClothSettings_voxel_cell_size,
	-1, "use_stiffness_scale", 1, "Stiffness Scaling",
	"If enabled, stiffness can be scaled along a weight painted vertex group",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_cloth_update, 0, NULL, NULL,
	0, -1, NULL},
	ClothSettings_use_stiffness_scale_get, ClothSettings_use_stiffness_scale_set, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL
};

FloatPropertyRNA rna_ClothSettings_spring_damping = {
	{(PropertyRNA *)&rna_ClothSettings_structural_stiffness, (PropertyRNA *)&rna_ClothSettings_use_stiffness_scale,
	...
	ClothSettings_spring_damping_get, ClothSettings_spring_damping_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0f, 50.0f, 0.0f, 50.0f, 10.0f, 3, 0.0f, NULL
};

FloatPropertyRNA rna_ClothSettings_structural_stiffness = {
	{(PropertyRNA *)&rna_ClothSettings_structural_stiffness_max, (PropertyRNA *)&rna_ClothSettings_spring_damping,
	...
	ClothSettings_structural_stiffness_get, ClothSettings_structural_stiffness_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0f, 10000.0f, 0.0f, 10000.0f, 10.0f, 3, 0.0f, NULL
};

FloatPropertyRNA rna_ClothSettings_structural_stiffness_max = {
	{(PropertyRNA *)&rna_ClothSettings_sewing_force_max, (PropertyRNA *)&rna_ClothSettings_structural_stiffness,
	...
	rna_cloth_update, 0, NULL, NULL,
	0, -1, NULL},
	ClothSettings_structural_stiffness_max_get, ClothSettings_structural_stiffness_max_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0f, 10000.0f, 0.0f, 10000.0f, 10.0f, 3, 0.0f, NULL
};

FloatPropertyRNA rna_ClothSettings_sewing_force_max = {
	{(PropertyRNA *)&rna_ClothSettings_vertex_group_structural_stiffness, (PropertyRNA *)&rna_ClothSettings_structural_stiffness_max,
	-1, "sewing_force_max", 3, "Sewing Force Max",
...
StringPropertyRNA rna_ClothSettings_vertex_group_structural_stiffness = {
	{(PropertyRNA *)&rna_ClothSettings_bending_stiffness, (PropertyRNA *)&rna_ClothSettings_sewing_force_max,
	-1, "vertex_group_structural_stiffness", 262145, "Structural Stiffness Vertex Group",
...
FloatPropertyRNA rna_ClothSettings_bending_stiffness = {
	{(PropertyRNA *)&rna_ClothSettings_bending_stiffness_max, (PropertyRNA *)&rna_ClothSettings_vertex_group_structural_stiffness,
...
FloatPropertyRNA rna_ClothSettings_bending_damping = {
	...
	-1, "bending_damping", 8195, "Bending Spring Damping",
	"Damping of bending motion",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_cloth_update, 0, NULL, NULL,
	offsetof(ClothSimSettings, bending_damping), 4, NULL},
...
BoolPropertyRNA rna_ClothSettings_use_sewing_springs = {
	...
	-1, "use_sewing_springs", 1, "Sew Cloth",
...
StringPropertyRNA rna_ClothSettings_vertex_group_bending = {
	...
	-1, "vertex_group_bending", 262145, "Bending Stiffness Vertex Group",
...
PointerPropertyRNA rna_ClothSettings_rest_shape_key = {
	{NULL, (PropertyRNA *)&rna_ClothSettings_effector_weights,
	-1, "rest_shape_key", 8388609, "Rest Shape Key",
...
StructRNA RNA_ClothSettings = {
	...
	NULL,
	{(PropertyRNA *)&rna_ClothSettings_rna_properties, (PropertyRNA *)&rna_ClothSettings_rest_shape_key}},
	"ClothSettings", NULL, NULL, 4, "Cloth Settings",
...
BoolPropertyRNA rna_ClothCollisionSettings_use_collision = {
	{(PropertyRNA *)&rna_ClothCollisionSettings_repel_force, (PropertyRNA *)&rna_ClothCollisionSettings_rna_type,
...
FloatPropertyRNA rna_ClothCollisionSettings_repel_force = {
	{(PropertyRNA *)&rna_ClothCollisionSettings_distance_repel, (PropertyRNA *)&rna_ClothCollisionSettings_use_collision,
	-1, "repel_force", 8195, "Repulsion Force",
	"Repulsion force to apply on cloth when close to colliding",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_cloth_update, 0, NULL, NULL,
	offsetof(ClothCollSettings, repel_force), 4, NULL},
	ClothCollisionSettings_repel_force_get, ClothCollisionSettings_repel_force_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0f, 20.0f, 0.0f, 20.0f, 10.0f, 3, 1.0f, NULL
};

FloatPropertyRNA rna_ClothCollisionSettings_distance_repel = {
	{(PropertyRNA *)&rna_ClothCollisionSettings_distance_min, (PropertyRNA *)&rna_ClothCollisionSettings_repel_force,
	-1, "distance_repel", 8195, "Repulsion Distance",
	"Maximum distance to apply repulsion force, must be greater than minimum distance",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_cloth_update, 0, NULL, NULL,
	offsetof(ClothCollSettings, distance_repel), 4, NULL},
	ClothCollisionSettings_distance_repel_get, ClothCollisionSettings_distance_repel_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0010000000f, 10.0f, 0.0010000000f, 10.0f, 10.0f, 3, 0.0049999999f, NULL
};

FloatPropertyRNA rna_ClothCollisionSettings_distance_min = {
	{(PropertyRNA *)&rna_ClothCollisionSettings_friction, (PropertyRNA *)&rna_ClothCollisionSettings_distance_repel,
...
IntPropertyRNA rna_ClothCollisionSettings_collision_quality = {
	{(PropertyRNA *)&rna_ClothCollisionSettings_use_self_collision, (PropertyRNA *)&rna_ClothCollisionSettings_damping,
...
BoolPropertyRNA rna_ClothCollisionSettings_use_self_collision = {
	{(PropertyRNA *)&rna_ClothCollisionSettings_self_distance_min, (PropertyRNA *)&rna_ClothCollisionSettings_collision_quality,
...
FloatPropertyRNA rna_ClothCollisionSettings_self_distance_min = {
	...
	ClothCollisionSettings_self_distance_min_get, ClothCollisionSettings_self_distance_min_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.5000000000f, 1.0f, 0.5000000000f, 1.0f, 10.0f, 3, 0.0f, NULL
};

FloatPropertyRNA rna_ClothCollisionSettings_self_friction = {
	{(PropertyRNA *)&rna_ClothCollisionSettings_self_collision_quality, (PropertyRNA *)&rna_ClothCollisionSettings_self_distance_min,
...
IntPropertyRNA rna_ClothCollisionSettings_self_collision_quality = {
	{(PropertyRNA *)&rna_ClothCollisionSettings_group, (PropertyRNA *)&rna_ClothCollisionSettings_self_friction,
	...
	ClothCollisionSettings_self_collision_quality_get, ClothCollisionSettings_self_collision_quality_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL,
	1, 10, 1, 10, 1, 0, NULL
};

PointerPropertyRNA rna_ClothCollisionSettings_group = {
	{(PropertyRNA *)&rna_ClothCollisionSettings_vertex_group_self_collisions, (PropertyRNA *)&rna_ClothCollisionSettings_self_collision_quality,
	-1, "group", 8388609, "Collision Group",
...
StringPropertyRNA rna_ClothCollisionSettings_vertex_group_self_collisions = {
	{NULL, (PropertyRNA *)&rna_ClothCollisionSettings_group,
	-1, "vertex_group_self_collisions", 262145, "Selfcollision Vertex Group",
...
StructRNA RNA_ClothCollisionSettings = {
	{(ContainerRNA *)&RNA_CurveMapPoint, (ContainerRNA *)&RNA_ClothSettings,
	NULL,
	{(PropertyRNA *)&rna_ClothCollisionSettings_rna_properties, (PropertyRNA *)&rna_ClothCollisionSettings_vertex_group_self_collisions}},
	"ClothCollisionSettings", NULL, NULL, 4, "Cloth Collision Settings",
