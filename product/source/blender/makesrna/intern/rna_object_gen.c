...
extern PointerPropertyRNA rna_Object_camera_fit_coords_scene;
...
FloatPropertyRNA rna_GameObjectSettings_angular_velocity_min;
FloatPropertyRNA rna_GameObjectSettings_angular_velocity_max;
...
IntPropertyRNA rna_GameObjectSettings_jump_max;
...
float GameObjectSettings_angular_velocity_min_get(PointerRNA *ptr)
{
	Object *data = (Object *)(ptr->data);
	return (float)(data->min_angvel);
}

void GameObjectSettings_angular_velocity_min_set(PointerRNA *ptr, float value)
{
	Object *data = (Object *)(ptr->data);
	data->min_angvel = CLAMPIS(value, 0.0f, 1000.0f);
}

float GameObjectSettings_angular_velocity_max_get(PointerRNA *ptr)
{
	Object *data = (Object *)(ptr->data);
	return (float)(data->max_angvel);
}

void GameObjectSettings_angular_velocity_max_set(PointerRNA *ptr, float value)
{
	Object *data = (Object *)(ptr->data);
	data->max_angvel = CLAMPIS(value, 0.0f, 1000.0f);
}
...
int GameObjectSettings_jump_max_get(PointerRNA *ptr)
{
	Object *data = (Object *)(ptr->data);
	return (int)(data->max_jumps);
}

void GameObjectSettings_jump_max_set(PointerRNA *ptr, int value)
{
	Object *data = (Object *)(ptr->data);
	data->max_jumps = CLAMPIS(value, 1, 255);
}

void GameObjectSettings_collision_group_get(PointerRNA *ptr, int values[16])
{
	rna_GameObjectSettings_col_group_get(ptr, values);
}

void GameObjectSettings_collision_group_set(PointerRNA *ptr, const int values[16])
{
	rna_GameObjectSettings_col_group_set(ptr, values);
}

void GameObjectSettings_collision_mask_get(PointerRNA *ptr, int values[16])
{
	rna_GameObjectSettings_col_mask_get(ptr, values);
}

void GameObjectSettings_collision_mask_set(PointerRNA *ptr, const int values[16])
{
...
void GameObjectSettings_states_initial_set(PointerRNA *ptr, const int values[30])
{
	...
	for (i = 0; i < 30; i++) {
		if (values[i]) data->init_state |= (1u << i);
...
int LodLevel_object_hysteresis_percentage_get(PointerRNA *ptr)
{
	LodLevel *data = (LodLevel *)(ptr->data);
	return (int)(data->obhysteresis);
}

void LodLevel_object_hysteresis_percentage_set(PointerRNA *ptr, int value)
{
	LodLevel *data = (LodLevel *)(ptr->data);
	data->obhysteresis = CLAMPIS(value, 0, 100);
}
...
int LodLevel_use_object_hysteresis_get(PointerRNA *ptr)
{
	LodLevel *data = (LodLevel *)(ptr->data);
	return (((data->flags) & 4) != 0);
}

void LodLevel_use_object_hysteresis_set(PointerRNA *ptr, int value)
{
	LodLevel *data = (LodLevel *)(ptr->data);
...
void Object_calc_matrix_camera(struct Object *_self, float result[16], int x, int y, float scale_x, float scale_y)
{
	rna_Object_calc_matrix_camera(_self, result, x, y, scale_x, scale_y);
}
...
void Object_camera_fit_coords(struct Object *_self, struct Scene *scene, int coordinates_len, float *coordinates, float co_return[3], float *scale_return)
{
	rna_Object_camera_fit_coords(_self, scene, coordinates_len, coordinates, co_return, scale_return);
}
...
void Object_ray_cast(struct Object *_self, ReportList *reports, float origin[3], float direction[3], float distance, int *result, float location[3], float normal[3], int *index)
{
	rna_Object_ray_cast(_self, reports, origin, direction, distance, result, location, normal, index);
}
...
void Object_closest_point_on_mesh(struct Object *_self, ReportList *reports, float origin[3], float distance, int *result, float location[3], float normal[3], int *index)
{
	rna_Object_closest_point_on_mesh(_self, reports, origin, distance, result, location, normal, index);
}
...
void Object_dm_info(struct Object *_self, int type, char * result)
{
	rna_Object_dm_info(_self, type, result);
}

void Object_dm_info_call(bContext *C, ReportList *reports, PointerRNA *_ptr, ParameterList *_parms)
{
	struct Object *_self;
	int type;
	char * result;
...
void rna_Object_calc_matrix_camera(struct Object *_self, float result[16], int x, int y, float scale_x, float scale_y);
void rna_Object_camera_fit_coords(struct Object *_self, struct Scene *scene, int coordinates_len, float *coordinates, float co_return[3], float *scale_return);
...
void rna_Object_ray_cast(struct Object *_self, ReportList *reports, float origin[3], float direction[3], float distance, int *result, float location[3], float normal[3], int *index);
void rna_Object_closest_point_on_mesh(struct Object *_self, ReportList *reports, float origin[3], float distance, int *result, float location[3], float normal[3], int *index);
...
void rna_Object_dm_info(struct Object *_self, int type, char * result);
...
static EnumPropertyItem rna_Object_mode_items[10] = {
...
EnumPropertyRNA rna_Object_mode = {
	...
	NULL, 0, NULL, NULL,
	0, -1, NULL},
	Object_mode_get, NULL, NULL, NULL, NULL, NULL, rna_Object_mode_items, 9, 0
};
...
static EnumPropertyItem rna_Object_parent_type_items[7] = {
...
FunctionRNA rna_Object_convert_space_func = {
	{(FunctionRNA *)&rna_Object_calc_matrix_camera_func, NULL,
	NULL,
...
FloatPropertyRNA rna_Object_calc_matrix_camera_result = {
	{(PropertyRNA *)&rna_Object_calc_matrix_camera_x, NULL,
	-1, "result", 11, "",
...
FunctionRNA rna_Object_calc_matrix_camera_func = {
	...
	NULL,
	{(PropertyRNA *)&rna_Object_calc_matrix_camera_result, (PropertyRNA *)&rna_Object_calc_matrix_camera_scale_y}},
	"calc_matrix_camera", 0, "Generate the camera projection matrix of this object (mostly useful for Camera and Lamp types)",
	Object_calc_matrix_camera_call,
	NULL
};

PointerPropertyRNA rna_Object_camera_fit_coords_scene = {
...
FloatPropertyRNA rna_Object_camera_fit_coords_coordinates = {
	{(PropertyRNA *)&rna_Object_camera_fit_coords_co_return, (PropertyRNA *)&rna_Object_camera_fit_coords_scene,
	-1, "coordinates", 393223, "",
...
FunctionRNA rna_Object_camera_fit_coords_func = {
	...
	NULL,
	{(PropertyRNA *)&rna_Object_camera_fit_coords_scene, (PropertyRNA *)&rna_Object_camera_fit_coords_scale_return}},
...
FunctionRNA rna_Object_to_mesh_func = {
	{(FunctionRNA *)&rna_Object_dupli_list_create_func, (FunctionRNA *)&rna_Object_camera_fit_coords_func,
	NULL,
	{(PropertyRNA *)&rna_Object_to_mesh_scene, (PropertyRNA *)&rna_Object_to_mesh_mesh}},
	"to_mesh", 16, "Create a Mesh data-block with modifiers applied",
	Object_to_mesh_call,
...
FloatPropertyRNA rna_Object_ray_cast_distance = {
	{(PropertyRNA *)&rna_Object_ray_cast_result, (PropertyRNA *)&rna_Object_ray_cast_direction,
	-1, "distance", 3, "",
	"Maximum distance",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
...
BoolPropertyRNA rna_Object_ray_cast_result = {
	{(PropertyRNA *)&rna_Object_ray_cast_location, (PropertyRNA *)&rna_Object_ray_cast_distance,
	-1, "result", 11, "",
	"",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
...
FloatPropertyRNA rna_Object_closest_point_on_mesh_distance = {
	{(PropertyRNA *)&rna_Object_closest_point_on_mesh_result, (PropertyRNA *)&rna_Object_closest_point_on_mesh_origin,
	-1, "distance", 3, "",
	"Maximum distance",
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
	0, -1, NULL},
	NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0f, FLT_MAX, 0.0f, FLT_MAX, 1.0f, 3, 18446742974197924000.0000000000f, NULL
};

BoolPropertyRNA rna_Object_closest_point_on_mesh_result = {
	{(PropertyRNA *)&rna_Object_closest_point_on_mesh_location, (PropertyRNA *)&rna_Object_closest_point_on_mesh_distance,
	-1, "result", 11, "",
	"",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
...
FunctionRNA rna_Object_closest_point_on_mesh_func = {
	...
	"closest_point_on_mesh", 16, "Find the nearest point in object space",
...
static EnumPropertyItem rna_Object_dm_info_type_items[4] = {
...
EnumPropertyRNA rna_Object_dm_info_type = {
	{(PropertyRNA *)&rna_Object_dm_info_result, NULL,
	-1, "type", 7, "",
	"Modifier settings to apply",
	0, "*",
	PROP_ENUM, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
	0, -1, NULL},
	NULL, NULL, NULL, NULL, NULL, NULL, rna_Object_dm_info_type_items, 3, 0
};

StringPropertyRNA rna_Object_dm_info_result = {
	{NULL, (PropertyRNA *)&rna_Object_dm_info_type,
	-1, "result", 8650761, "result",
	"",
	0, "*",
	PROP_STRING, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
...
FunctionRNA rna_Object_dm_info_func = {
	...
	"dm_info", 0, "Returns a string for derived mesh data",
	Object_dm_info_call,
	NULL
};
...
StructRNA RNA_Object = {
	...
	NULL,
	rna_ID_idprops,
	{(FunctionRNA *)&rna_Object_convert_space_func, (FunctionRNA *)&rna_Object_cache_release_func}
};
...
static EnumPropertyItem rna_ObjectModifiers_new_type_items[55] = {
	{0, "", 0, "Modify", ""},
	...
	{17, "CAST", 462, "Cast", ""},
	{51, "CORRECTIVE_SMOOTH", 465, "Corrective Smooth", ""},
	{3, "CURVE", 457, "Curve", ""},
...
EnumPropertyRNA rna_ObjectModifiers_new_type = {
	...
	NULL, 0, NULL, NULL,
	0, -1, NULL},
	NULL, NULL, NULL, NULL, NULL, NULL, rna_ObjectModifiers_new_type_items, 54, 1
};
...
static EnumPropertyItem rna_GameObjectSettings_physics_type_items[10] = {
	...
	{5, "OCCLUDER", 0, "Occluder", "Occluder for optimizing scene rendering"},
...
EnumPropertyRNA rna_GameObjectSettings_physics_type = {
	...
	0, -1, NULL},
	GameObjectSettings_physics_type_get, GameObjectSettings_physics_type_set, NULL, NULL, NULL, NULL, rna_GameObjectSettings_physics_type_items, 9, 1
};
...
FloatPropertyRNA rna_GameObjectSettings_mass = {
	...
	GameObjectSettings_mass_get, GameObjectSettings_mass_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0099999998f, 10000.0f, 0.0099999998f, 10000.0f, 10.0f, 3, 1.0f, NULL
};
...
FloatPropertyRNA rna_GameObjectSettings_radius = {
	...
	GameObjectSettings_radius_get, GameObjectSettings_radius_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0099999998f, 10.0f, 0.0099999998f, FLT_MAX, 1.0f, 3, 1.0f, NULL
};
...
FloatPropertyRNA rna_GameObjectSettings_damping = {
	...
	GameObjectSettings_damping_get, GameObjectSettings_damping_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0f, 1.0f, 0.0f, 1.0f, 10.0f, 3, 0.0399999991f, NULL
};
...
FloatPropertyRNA rna_GameObjectSettings_rotation_damping = {
	...
	GameObjectSettings_rotation_damping_get, GameObjectSettings_rotation_damping_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0f, 1.0f, 0.0f, 1.0f, 10.0f, 3, 0.1000000015f, NULL
};
...
FloatPropertyRNA rna_GameObjectSettings_velocity_max = {
	{(PropertyRNA *)&rna_GameObjectSettings_angular_velocity_min, (PropertyRNA *)&rna_GameObjectSettings_velocity_min,
...
FloatPropertyRNA rna_GameObjectSettings_angular_velocity_min = {
	{(PropertyRNA *)&rna_GameObjectSettings_angular_velocity_max, (PropertyRNA *)&rna_GameObjectSettings_velocity_max,
	-1, "angular_velocity_min", 8193, "Angular Velocity Min",
	...
	NULL, 0, NULL, NULL,
	offsetof(Object, min_angvel), 4, NULL},
	GameObjectSettings_angular_velocity_min_get, GameObjectSettings_angular_velocity_min_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0f, 1000.0f, 0.0f, 1000.0f, 10.0f, 3, 0.0f, NULL
};

FloatPropertyRNA rna_GameObjectSettings_angular_velocity_max = {
	{(PropertyRNA *)&rna_GameObjectSettings_step_height, (PropertyRNA *)&rna_GameObjectSettings_angular_velocity_min,
	-1, "angular_velocity_max", 8193, "Angular Velocity Max",
	"Clamp angular velocity to this maximum speed, in angle per second",
	0, "*",
	PROP_FLOAT, PROP_ANGLE | PROP_UNIT_ROTATION, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
	offsetof(Object, max_angvel), 4, NULL},
	GameObjectSettings_angular_velocity_max_get, GameObjectSettings_angular_velocity_max_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0f, 1000.0f, 0.0f, 1000.0f, 10.0f, 3, 0.0f, NULL
};

FloatPropertyRNA rna_GameObjectSettings_step_height = {
	{(PropertyRNA *)&rna_GameObjectSettings_jump_speed, (PropertyRNA *)&rna_GameObjectSettings_angular_velocity_max,
	...
	GameObjectSettings_step_height_get, GameObjectSettings_step_height_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0099999998f, 1.0f, 0.0099999998f, 1.0f, 10.0f, 3, 0.1500000060f, NULL
};
...
FloatPropertyRNA rna_GameObjectSettings_jump_speed = {
	...
	GameObjectSettings_jump_speed_get, GameObjectSettings_jump_speed_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0f, 1000.0f, 0.0f, 1000.0f, 10.0f, 3, 10.0f, NULL
};

FloatPropertyRNA rna_GameObjectSettings_fall_speed = {
	{(PropertyRNA *)&rna_GameObjectSettings_jump_max, (PropertyRNA *)&rna_GameObjectSettings_jump_speed,
	...
	GameObjectSettings_fall_speed_get, GameObjectSettings_fall_speed_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0f, 1000.0f, 0.0f, 1000.0f, 10.0f, 3, 55.0f, NULL
};

IntPropertyRNA rna_GameObjectSettings_jump_max = {
	{(PropertyRNA *)&rna_GameObjectSettings_collision_group, (PropertyRNA *)&rna_GameObjectSettings_fall_speed,
	-1, "jump_max", 8193, "Max Jumps",
	"The maximum number of jumps the character can make before it hits the ground",
	0, "*",
	PROP_INT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL,
	offsetof(Object, max_jumps), 2, NULL},
	GameObjectSettings_jump_max_get, GameObjectSettings_jump_max_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL,
	1, 10, 1, 255, 1, 1, NULL
};

static int rna_GameObjectSettings_collision_group_default[16] = {
	0,
	0,
	0,
	0,
...
BoolPropertyRNA rna_GameObjectSettings_collision_group = {
	{(PropertyRNA *)&rna_GameObjectSettings_collision_mask, (PropertyRNA *)&rna_GameObjectSettings_jump_max,
	-1, "collision_group", 1, "Collision Group",
	"The collision group of the object",
	0, "*",
	PROP_BOOLEAN, PROP_LAYER_MEMBER | PROP_UNIT_NONE, NULL, 1, {16, 0, 0}, 16,
	NULL, 0, NULL, NULL,
	0, -1, NULL},
...
static int rna_GameObjectSettings_collision_mask_default[16] = {
	0,
	0,
	0,
	0,
...
FloatPropertyRNA rna_GameObjectSettings_form_factor = {
	...
	GameObjectSettings_form_factor_get, GameObjectSettings_form_factor_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0f, 1.0f, 0.0f, 1.0f, 10.0f, 3, 0.4000000060f, NULL
};
...
static EnumPropertyItem rna_GameObjectSettings_collision_bounds_type_items[8] = {
	{0, "BOX", 287, "Box", ""},
	{1, "SPHERE", 289, "Sphere", ""},
	{2, "CYLINDER", 293, "Cylinder", ""},
	{3, "CONE", 295, "Cone", ""},
	{5, "CONVEX_HULL", 290, "Convex Hull", ""},
	{4, "TRIANGLE_MESH", 292, "Triangle Mesh", ""},
	{7, "CAPSULE", 296, "Capsule", ""},
	{0, NULL, 0, NULL, NULL}
};

EnumPropertyRNA rna_GameObjectSettings_collision_bounds_type = {
	{(PropertyRNA *)&rna_GameObjectSettings_use_collision_compound, (PropertyRNA *)&rna_GameObjectSettings_use_collision_bounds,
	-1, "collision_bounds_type", 1, "Collision Shape",
...
FloatPropertyRNA rna_GameObjectSettings_collision_margin = {
	...
	GameObjectSettings_collision_margin_get, GameObjectSettings_collision_margin_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0f, 1.0f, 0.0f, 1.0f, 10.0f, 3, 0.0399999991f, NULL
};
...
FloatPropertyRNA rna_GameObjectSettings_obstacle_radius = {
	...
	GameObjectSettings_obstacle_radius_get, GameObjectSettings_obstacle_radius_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.0f, 1000.0f, 0.0f, 1000.0f, 10.0f, 3, 1.0f, NULL
};
...
FloatPropertyRNA rna_LodLevel_distance = {
	{(PropertyRNA *)&rna_LodLevel_object_hysteresis_percentage, (PropertyRNA *)&rna_LodLevel_rna_type,
...
IntPropertyRNA rna_LodLevel_object_hysteresis_percentage = {
	{(PropertyRNA *)&rna_LodLevel_object, (PropertyRNA *)&rna_LodLevel_distance,
	-1, "object_hysteresis_percentage", 8195, "Hysteresis %",
	"Minimum distance change required to transition to the previous level of detail",
	0, "*",
	PROP_INT, PROP_PERCENTAGE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 85852160, NULL, NULL,
	offsetof(LodLevel, obhysteresis), 0, NULL},
	LodLevel_object_hysteresis_percentage_get, LodLevel_object_hysteresis_percentage_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL,
	0, 100, 0, 100, 10, 0, NULL
};

PointerPropertyRNA rna_LodLevel_object = {
	{(PropertyRNA *)&rna_LodLevel_use_mesh, (PropertyRNA *)&rna_LodLevel_object_hysteresis_percentage,
...
BoolPropertyRNA rna_LodLevel_use_material = {
	{(PropertyRNA *)&rna_LodLevel_use_object_hysteresis, (PropertyRNA *)&rna_LodLevel_use_mesh,
...
BoolPropertyRNA rna_LodLevel_use_object_hysteresis = {
	{NULL, (PropertyRNA *)&rna_LodLevel_use_material,
	-1, "use_object_hysteresis", 3, "Hysteresis Override",
	"Override LoD Hysteresis scene setting for this LoD level",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 85852160, NULL, NULL,
	0, -1, NULL},
	LodLevel_use_object_hysteresis_get, LodLevel_use_object_hysteresis_set, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL
};

StructRNA RNA_LodLevel = {
	{(ContainerRNA *)&RNA_PointCache, (ContainerRNA *)&RNA_DupliObject,
	NULL,
	{(PropertyRNA *)&rna_LodLevel_rna_properties, (PropertyRNA *)&rna_LodLevel_use_object_hysteresis}},
