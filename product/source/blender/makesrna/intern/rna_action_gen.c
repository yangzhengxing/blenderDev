...
BoolPropertyRNA rna_DopeSheet_use_filter_text;
...
int DopeSheet_use_filter_text_get(PointerRNA *ptr)
{
	bDopeSheet *data = (bDopeSheet *)(ptr->data);
	return (((data->filterflag) & 134217728) != 0);
}

void DopeSheet_use_filter_text_set(PointerRNA *ptr, int value)
{
	bDopeSheet *data = (bDopeSheet *)(ptr->data);
	if (value) data->filterflag |= 134217728;
	else data->filterflag &= ~134217728;
...
int DopeSheet_show_gpencil_get(PointerRNA *ptr)
{
	bDopeSheet *data = (bDopeSheet *)(ptr->data);
	return !(((data->filterflag) & 16777216) != 0);
}

void DopeSheet_show_gpencil_set(PointerRNA *ptr, int value)
{
	bDopeSheet *data = (bDopeSheet *)(ptr->data);
...
int DopeSheet_show_gpencil_3d_only_get(PointerRNA *ptr)
{
	bDopeSheet *data = (bDopeSheet *)(ptr->data);
	return (((data->filterflag) & 536870912) != 0);
}

void DopeSheet_show_gpencil_3d_only_set(PointerRNA *ptr, int value)
{
	bDopeSheet *data = (bDopeSheet *)(ptr->data);
...
CollectionPropertyRNA rna_Action_pose_markers = {
	...
	-1, "pose_markers", 65536, "Pose Markers",
...
static EnumPropertyItem rna_Action_id_root_items[33] = {
...
EnumPropertyRNA rna_Action_id_root = {
	...
	NULL, 0, NULL, NULL,
	0, -1, NULL},
	Action_id_root_get, Action_id_root_set, NULL, NULL, NULL, NULL, rna_Action_id_root_items, 32, 17217
};
...
FunctionRNA rna_ActionFCurves_new_func = {
	...
	"new", 16, "Add an F-Curve to the action",
...
PointerPropertyRNA rna_ActionPoseMarkers_active = {
	...
	-1, "active", 8454145, "Active Pose Marker",
...
IntPropertyRNA rna_ActionPoseMarkers_active_index = {
	...
	-1, "active_index", 65539, "Active Pose Marker Index",
...
StringPropertyRNA rna_DopeSheet_filter_fcurve_name = {
	{(PropertyRNA *)&rna_DopeSheet_use_filter_text, (PropertyRNA *)&rna_DopeSheet_show_only_matching_fcurves,
	-1, "filter_fcurve_name", -2147221503, "F-Curve Name Filter",
...
BoolPropertyRNA rna_DopeSheet_use_filter_text = {
	{(PropertyRNA *)&rna_DopeSheet_filter_text, (PropertyRNA *)&rna_DopeSheet_filter_fcurve_name,
	-1, "use_filter_text", 3, "Only Matching Channels",
	"Only include channels with names containing search text",
	30, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 239599617, NULL, NULL,
	0, -1, NULL},
	DopeSheet_use_filter_text_get, DopeSheet_use_filter_text_set, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL
};

StringPropertyRNA rna_DopeSheet_filter_text = {
	{(PropertyRNA *)&rna_DopeSheet_show_missing_nla, (PropertyRNA *)&rna_DopeSheet_use_filter_text,
	-1, "filter_text", -2147221503, "Name Filter",
...
BoolPropertyRNA rna_DopeSheet_show_missing_nla = {
	{(PropertyRNA *)&rna_DopeSheet_show_summary, (PropertyRNA *)&rna_DopeSheet_filter_text,
...
BoolPropertyRNA rna_DopeSheet_show_speakers = {
	{(PropertyRNA *)&rna_DopeSheet_show_gpencil, (PropertyRNA *)&rna_DopeSheet_show_nodes,
...
BoolPropertyRNA rna_DopeSheet_show_gpencil = {
	{(PropertyRNA *)&rna_DopeSheet_show_gpencil_3d_only, (PropertyRNA *)&rna_DopeSheet_show_speakers,
	-1, "show_gpencil", 3, "Display Grease Pencil",
...
BoolPropertyRNA rna_DopeSheet_show_gpencil_3d_only = {
	...
	-1, "show_gpencil_3d_only", 3, "Active Scene Only",
